...
///
/// Provides file download, browser preview, and file conversion
/// functionality for web applications.
class FileDownloadService {
  /// Creates a file download service instance.
  FileDownloadService({
    Dio? dio,
  ...
  /// Singleton instance of the file download service.
  ...
  ///
  /// Returns a Future<> with the download result
  ///
  /// Example usage:
  /// ```dart
