...
import 'web.dart' if (dart.library.io) 'stub.dart';
...
class FileDownloadService {
  ...
  Future<String> _saveFile(Uint8List bytes, String fileName) async {
    if (_customFileSaver != null) {
      return await _customFileSaver(bytes, fileName);
    }
  ...
  /// Opens a file in a new tab if the browser can display it, otherwise downloads it
  ///
  /// [bytes] - The file data as bytes
  /// [fileName] - The name of the file (including extension)
  ///
  /// Files that can be opened in browser (PDF, images, text, HTML, etc.) will open in a new tab.
  /// Files that cannot be displayed (DOCX, XLSX, ZIP, etc.) will be downloaded.
  ///
  /// Note: This method only works on web platforms. On non-web platforms, it will download the file.
