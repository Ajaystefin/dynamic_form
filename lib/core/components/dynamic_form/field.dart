...
/// Renders a dynamic form field based on its configuration.
class DynamicFormField extends StatefulWidget {
  /// Creates a [DynamicFormField].
...
class _DynamicFormFieldState extends State<DynamicFormField> {
  ...
  Widget formWidget() {
    ...
    logger.i('Key: ${fieldKey.isEmpty ? "<empty>" : fieldKey} '
...
/// Formats text input to allow only numeric values with a decimal point.
class NumericFloatingPointFormatter extends TextInputFormatter {
  /// Formats and validates numeric input.
  @override
