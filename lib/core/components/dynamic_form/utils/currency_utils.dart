...
class CurrencyUtils {
  ...
  ///
  /// Rounds to the nearest whole unit for display only. The underlying
  /// numeric values stored in the document (and sent to the API) keep their
  /// full decimal precision.
  ///
  /// Example: 1234.56 -> "1,235"
  static String formatCurrency(double value) {
    return _currencyFormatter.format(value.round());
  }
  ...
  static double? _parseNumericValue(value) {
    if (value == null) {
      return null;
    }
    if (value is num) {
