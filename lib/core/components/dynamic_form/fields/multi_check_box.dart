...
class DynamicFormMultiCheckBox extends StatefulWidget {
  /// Creates a [DynamicFormMultiCheckBox].
  ...
  /// Callback invoked when the selected options change.
  final Function(List<String>) onChanged;

  /// Callback invoked when the field value is saved.
  final Function(List<String>?) onSaved;

  /// Validation callback for selected options.
...
class _DynamicFormMultiCheckBoxState extends State<DynamicFormMultiCheckBox> {
  ...
  void _initializeSelectedKeys() {
    ...
    if (existingValue is List) {
      ...
      logger.i("MultiCheckBox initState: no existing data, starting empty");
    }
  }
