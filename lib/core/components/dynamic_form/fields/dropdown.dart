...
/// Dynamic dropdown form field.
class DynamicFormDropdown extends StatefulWidget {
  /// Creates a [DynamicFormDropdown].
...
/// Returns the selected option from the document for the given field and row.
Option? syncSelectedOptionFromDocument({
  ...
  if (storedKeyRaw == null || fieldData.optionList == null) {
    return null;
  }
