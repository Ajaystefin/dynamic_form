...
/// A dynamic multi-select dropdown field for dynamic forms.
///
/// Displays available options from [fieldData] and allows users
/// to select multiple values.
class DynamicFormMultiSelectDropdown extends StatelessWidget {
  /// Creates a [DynamicFormMultiSelectDropdown].
  ...
  /// Callback invoked when selected options change.
  final Function(List<dynamic>) selectedOptions;

  /// Form document data.
  final Map<String, dynamic> document;

  /// Scroll controller for the selected items display.
  ...
  Widget build(BuildContext context) {
    ...
    if (currentValue is List) {
      ...
      logger.i("Available values from optionList: $availableValues");
      ...
      logger.i("Filtered selectedItems: $selectedItems");
    } else {}
    logger.i("===================");
