...
class CustomTextEditorWidget extends StatelessWidget {
  ...
  // Whether the font size unit button is enabled in the toolbar (default is true).
  final bool showFontSizeUnit;

  // Whether the list styles button (numberedList andbulletList) is enabled (default is true).
  ...
  // The hint text to display in the editor when no text is entered (default is 'Your text here...').
  final String hintText;

  // Whether to ensure the editor is visible when the user starts typing (default is true).
