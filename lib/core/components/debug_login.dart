  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (inputText.isEmpty) {
        throw ApiException("Please paste SSO response data");
      }
      ...
      if (!queryParams.containsKey("tokenResponse") ||
        ...
        const errorMessage =
            "Missing required fields: tokenResponse and userResponse";
      ...
      if (queryParams.containsKey("sessionID")) {
        ...
        logger.i("Session ID set from debug input: ${Globals.sessionID}");
      }
