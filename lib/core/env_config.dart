...
class EnvConfig {
  ...
  static bool get useTinyMceEditor =>
      ...
      const bool.fromEnvironment("useTinyMceEditor", defaultValue: false);
  static bool get isSSOEnabled =>
      _config?["isSSOEnabled"] ??
      const bool.fromEnvironment("isSSOEnabled", defaultValue: false);
  static String get ssoUrl =>
      _config?["ssoUrl"] ??
      const String.fromEnvironment("ssoUrl", defaultValue: "");
  static String get spreadSmartUrl =>
      _config?["spreadSmartUrl"] ??
      const String.fromEnvironment("spreadSmartUrl", defaultValue: "");
  static bool get disableRestriction =>
      _config?["disableRestriction"] ??
      const bool.fromEnvironment("disableRestriction", defaultValue: false);
}
