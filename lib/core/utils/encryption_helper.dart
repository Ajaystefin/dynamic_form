...
/// Encryption Helper
///
/// Provides utility methods for encryption, decryption,
/// device identification, and encryption key generation.
class EncryptionHelper {
  ...
  /// Returns the AES encryption key derived from the current session.
  ///
  ...
  static String encrypt(String plainText) {
    ...
    // logger.i("value after decrypting is $decrypted key is
    // ${getAesKey().toString()}");
    return enc;
  }
