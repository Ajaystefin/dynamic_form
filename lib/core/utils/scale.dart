...
/// A class to help you scale your design on bigger or smaller screens to
/// achieve the same design look.
class Scale {
  /// Design reference size used for scaling calculations.
  ...
  /// Setup the screen with the device screen [Size] and the [size] you will
  /// use.
...
extension ScreenExtension on num {
  ...
  /// Returns the diagonally scaled value.
  double get sd {
...
///
/// Provides helpers for determining the current device type.
extension DeviceType on BuildContext {
  /// Returns the current device screen type.
  ...
  /// Indicates whether the device is tablet.
  bool get isTablet => deviceScreenType == DeviceScreenType.tablet;

  /// Indicates whether the device is desktop.
