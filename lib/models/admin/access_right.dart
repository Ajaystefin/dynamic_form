...
class AccessRight {
  ...
  AccessRight.fromJson(Map<String, dynamic> json) {
    ...
    if (json['pageList'] != null && json['pageList'] is List) {
      pages = <Page>[];
      for (Map<String, dynamic> pageJson in json['pageList']) {
    ...
    if (json['pageIds'] != null && json['pageIds'] is List) {
      pages = <Page>[];
      for (Map<String, dynamic> pageJson in json['pageIds']) {
        pages?.add(Page.fromJson(pageJson));
      }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (pages != null) {
      List<Page> updatedPages = pages!.where((page) => page.isUpdated).toList();
