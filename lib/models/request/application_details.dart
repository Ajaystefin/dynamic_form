...
class ApplicationDetails {
  ...
  DateTime? custRequestRecieved;
  DateTime? markForwardDate;
  String? instanceId;
  bool? conventional;
  bool? islamic;
  // int? lastApprovedAppDate;
  ...
  ApplicationDetails.fromJson(Map<String, dynamic> json) {
    ...
    if (json['custRequestRecieved'] != null) {
      custRequestRecieved =
          DateTimeUtils.intToDateTime(json['custRequestRecieved']);
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['custRequestRecieved'] = custRequestRecieved;
  ...
  Map<String, dynamic> toSaveApplicationJson() {
    ...
    data['custReqRecvdDate'] = custRequestRecieved?.toIso8601String(); //
