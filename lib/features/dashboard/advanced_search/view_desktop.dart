...
class _ViewDesktopState extends State<ViewDesktop> {
  ...
  Widget build(BuildContext context) {
    AdvancedSearchViewModel viewModel = context.read<AdvancedSearchViewModel>();
  ...
  Widget _body(BuildContext context, AdvancedSearchState state,
  ...
  Widget buildView(
      AdvancedSearchViewModel viewModel, AdvancedSearchState state) {
    return BoxLayout(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomSelectableText(
                  style: const TextStyle(
                      color: AppColors.loginBackground, fontSize: 17),
