...
import "package:wcas_frontend/features/dashboard/closed_requests/fields/worklist_table.dart";
...
/// Desktop view for the closed requests screen.
    ...
    switch (state.loaderStatus) {
      ...
      default:
        return SingleChildScrollView(
          child: BoxLayout(
            child: viewModel.isCCSYS
                ? WorklistTable(viewModel: viewModel, state: state)
                : ClosedRequestTable(state: state, viewModel),
          ),
        );
    }
  }
