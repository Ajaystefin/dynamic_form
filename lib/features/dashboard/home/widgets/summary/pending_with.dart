...
/// Displays pending-with summary chips on the dashboard home screen.
class PendingWith extends StatelessWidget {
  /// Creates a [PendingWith].
  const PendingWith(this.viewModel, {super.key});

  /// Home dashboard view model used to provide summary counts.
  ...
  Widget build(BuildContext context) {
    ...
    final int? pendingWithCreditControlCCSYS =
        viewModel.firstKeyForSummaryCount(
      viewModel.summaryData?.pendingWithCreditControlCCSYS,
    );
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            if (pendingWithCreditControlCCSYS != -1)
              ChipWidget(
                viewModel: viewModel,
                summaryType: SummaryType.creditcontrolCCSYS,
                count: pendingWithCreditControlCCSYS,
              ),
