...
/// Displays returned request summary chips on the dashboard home screen.
class ReturnedRequest extends StatelessWidget {
  /// Creates a [ReturnedRequest].
  const ReturnedRequest(this.viewModel, {super.key});

  /// Home dashboard view model used to provide returned request summary counts.
  ...
  Widget build(BuildContext context) {
    ...
    final int? returnedToDC =
        viewModel.firstKeyForSummaryCount(viewModel.summaryData?.returnedToDC);
