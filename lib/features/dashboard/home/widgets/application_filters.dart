...
/// Displays application filter cards on the dashboard home screen.
class ApplicationFilters extends StatelessWidget {
  /// Creates an [ApplicationFilters].
  ...
  /// Mapping of application filter types to display labels.
  ...
  /// Builds an application filter card.
