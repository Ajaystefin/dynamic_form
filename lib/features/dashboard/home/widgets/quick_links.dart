            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(!widget.viewModel.isQuickLinkClicked
                ...
                children: [
                  ...
                  if (!Utils.checkRoles([
                    ...
                    iconButton(
                      ...
                      text: !Utils.checkRoles([
                        UserRole.relationshipOfficer,
                        UserRole.relationshipManager
                      ])
                          ? "dashboard.home.editViewProject".tr()
                          : "dashboard.home.createViewProject".tr(),
                      onTap: () => router.go(Routes.createProject),
                    ),
                  if (!Utils.checkRoles([
                    UserRole.icsAdmin,
                  ]))
