...
/// Desktop view for the dashboard home screen.
        ...
        if (state.loaderStatus == LoadingStatus.loading) {
          ...
          return Layout(
            ...
            child: SingleChildScrollView(
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: AppStyle.spacing),
                child: BoxLayout(
                  child: Stack(
                    children: [
                      Column(
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Gap(direction: Axis.horizontal),
                            TextButton(
                              onPressed: () => router.go(Routes.advancedSearch),
                              child: Row(
                                children: [
                                  const Icon(
                                    Icons.search,
                                  ...
                                  const Gap(direction: Axis.horizontal),
                                  Text(
                                    "dashboard.home.filter.advancedSearch".tr(),
