...
/// Desktop view for displaying and managing workflow configurations.
...
class _ViewDesktopState extends State<ViewDesktop> {
  ...
  Widget build(BuildContext context) {
    final viewModel = context.read<WorkflowConfigViewModel>();
  ...
  Widget _buildView(
    ...
    return Column(
      ...
      children: [
        ...
        // Table always renders (shows headers + "No data" when list is empty)
