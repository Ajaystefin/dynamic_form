...
/// Handles draft save and restore operations for the update reference dialog.
class UpdateReferenceDialogDraftHandler
  ...
  /// Resolves the draft key for the current reference and reference type.
  ...
  /// Applies stored draft data to the view model.
  @override
  void applyDraft(
