...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    FileAccessViewModel viewModel = context.read<FileAccessViewModel>();
  ...
  Widget _body(BuildContext context, FileAccessState state,
  ...
  Widget _buildView(BuildContext context, FileAccessState state,
      FileAccessViewModel viewModel) {
