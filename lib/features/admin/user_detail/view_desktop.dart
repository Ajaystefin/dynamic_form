...
/// Desktop view for displaying and editing user detail access information.
class ViewDesktop extends StatelessWidget {
  /// Creates a [ViewDesktop] widget.
  const ViewDesktop({super.key});

  /// Builds the desktop user detail view.
  @override
  ...
  /// Builds the main user detail form content.
  Widget buildView(
    BuildContext context,
    UserDetailState state,
    UserDetailViewModel viewModel,
          ...
          Align(
            ...
            child: Row(
              ...
              children: [
                CustomButton(
                  isLoading:
                      state.saveUserDetailStatus == LoadingStatus.loading,
