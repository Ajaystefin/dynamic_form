...
/// Displays and manages customer segment access for a user.
class UserAccessToCustomerSegment extends StatelessWidget {
  /// Creates a [UserAccessToCustomerSegment] widget.
  UserAccessToCustomerSegment({required this.viewModel, super.key});

  /// View model used to manage selected customer segment access values.
  final UserDetailViewModel viewModel;

  final ScrollController _scrollController = ScrollController();

  /// Builds the customer segment access multi-select dropdown.
  @override
