...
class UserAccessRights extends StatefulWidget {
  const UserAccessRights({super.key, required this.viewModel});
      ...
      return CustomRawTable(
        ...
        rows: [
          ...
          _buildRow(
            ...
            onChanged: (val) {
              context.read<UserDetailViewModel>().onApprovalAccessSelected(val);
            },
          ),
          _buildRow(
            label: 'admin.userManagementDetail.transactionApprovalAccess'.tr(),
