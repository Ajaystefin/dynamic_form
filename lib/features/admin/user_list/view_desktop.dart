...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    UserListViewModel viewModel = context.read<UserListViewModel>();
    return BlocBuilder<UserListViewModel, UserListState>(
      ...
      return Layout(
        ...
        child: BoxLayout(
          ...
          CustomSectionHeader(title: "admin.userManagementList.usersList".tr()),
          const Gap(),
          Column(
  ...
  Widget _body(
      BuildContext context, UserListState state, UserListViewModel viewModel) {
