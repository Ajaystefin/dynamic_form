...
import 'model.dart';
import 'state.dart';
import 'widgets/reference_type_field.dart';
...
class _ViewDesktopState extends State<ViewDesktop> {
  ...
  Widget _body(BuildContext context, ManageReferenceState state,
      ManageReferenceViewModel viewModel) {
  ...
  Widget _buildTable(BuildContext context, ManageReferenceState state,
      ManageReferenceViewModel viewModel) {
  ...
  Widget _buildView(BuildContext context, ManageReferenceState state,
      ManageReferenceViewModel viewModel) {
    return Column(
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      viewModel.onReferenceDataSelected(
