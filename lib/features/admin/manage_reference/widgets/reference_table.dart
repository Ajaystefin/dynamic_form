...
class ReferenceTableField extends StatelessWidget {
  const ReferenceTableField({super.key, required this.viewModel});
  ...
  List<List<Widget>> getTableRows(List<Reference> references,
      ReferenceType? selectedReferenceType, BuildContext context) {
