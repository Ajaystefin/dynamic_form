...
class TopMenuSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    LayoutViewModel viewModel = context.watch<LayoutViewModel>();
    logger.f("hideSideMenu ${viewModel.state.hideSideMenu}");
    return Padding(
                      ...
                      Padding(
                        ...
                        child: CustomDropdown<Role>(
                          ...
                          onBeforeChange: (previousValue, currentValue) async {
                            return await viewModel.showConfirmDialog(
                                context, currentValue ?? Role());
                          },
                          items: Globals.user?.availableRoles,
                          validationMessage: "",
                          dropdownBuilder: (context, item) =>
                              dropdownBuilderWidget(
                                  showToolTip: true, text: item?.name ?? ""),
