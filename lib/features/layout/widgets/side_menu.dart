...
/// Side menu drawer used for application navigation.
          ...
          children: [
            ...
            if (viewModel.isCurrentRouteCCSYS()) ...[
                ...
                children: [
                  ...
                  if (Utils.checkRoles([
                    ...
                    DrawerListTile(
                      ...
                      route: Routes.ccsysTerminateWithdraw,
                    ),
                ],
              ),
              // if (AuthRepository.hasRight(
              ...
              if (AuthRepository.hasRight(
                ...
                // RightConstants.workflowConfiguration))
                DrawerListTile(
              ...
              DrawerExpansionTile(
                ...
                children: [
                  if (AuthRepository.hasRight(
                    ...
                    DrawerListTile(
                      title: "layout.sidemenu.businessVolumeAccountStats".tr(),
                      route: viewModel.state.currentRoute == Routes.accountStats
                          ? Routes.accountStats
              ...
              DrawerExpansionTile(
                ...
                children: [
                  ...
                  if (AuthRepository.hasRight(
                    ...
                    DrawerListTile(
                      title: "layout.sidemenu.documentationCertification".tr(),
              ...
              DrawerExpansionTile(
                ...
                children: [
                  if (ApprovalUtils.checkMasterAccessibilityForRoute(
...
/// Drawer list tile item used inside the side menu.
class DrawerListTile extends StatelessWidget {
  // final bool isEnabled;

  /// Creates a drawer list tile.
  ...
  /// Title displayed for the drawer item.
  final String title;

  /// Route to navigate when the drawer item is tapped.
  final String route;
        ...
        child: Semantics(
          ...
          child: ListTile(
            ...
            onTap: menuMode != MenuMode.enabled
                ...
                : () {
                    // WidgetsBinding.instance.addPostFrameCallback((_) {
                    //   if (_controller.hasClients && _offsetCache > 0) {
                    //     _controller.jumpTo(_offsetCache);
                    //   }
                    // });
...
/// Drawer expansion tile item used to group side menu items.
class DrawerExpansionTile extends StatefulWidget {
  /// Creates a drawer expansion tile.
  ...
  /// Title displayed for the expansion tile.
  final String title;

  /// Children displayed when the expansion tile is expanded.
