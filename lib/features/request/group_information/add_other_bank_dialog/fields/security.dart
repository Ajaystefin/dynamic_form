...
/// Security selection field widget.
class SecurityField extends StatelessWidget {
  /// Creates a [SecurityField] widget.
  SecurityField({required this.viewModel, super.key});

  /// View model used by the widget.
  final AddOtherBankDialogViewModel viewModel;

  /// Scroll controller used by the selected security items.
