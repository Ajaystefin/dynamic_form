...
class NameOfBanks extends StatelessWidget {
  ...
  const NameOfBanks({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    return LabelWidget(
      ...
      child: CustomDropdown<Reference>(
        semanticLabel:  'groupInformation.facilitiesWithOtherBanks.nameofBanks'.tr(),
        ...
        validationMessage: (viewModel.showCurrentFiCreditRisk)
            ? ''
            : "requestInformation.requiredField".tr(),
