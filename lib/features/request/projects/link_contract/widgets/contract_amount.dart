...
/// Contract amount field for link contract.
class ContractAmount extends StatelessWidget {
  /// Creates a contract amount field.
  const ContractAmount({required this.viewModel, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return LabelWidget(
      ...
      child: Column(
        children: [
          CustomTextField(
            key: const ValueKey("ContractAmount"),
            ...
            prefixIcon: CustomDropdown<Reference>(
              ...
              selectedItems: [
                if (viewModel.countryCodes.isNotEmpty)
