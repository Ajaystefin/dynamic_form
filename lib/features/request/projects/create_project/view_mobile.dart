...
class ViewMobile extends StatelessWidget {
  ...
  const ViewMobile(this.isCreateProject, {super.key});

  @override
  Widget build(BuildContext context) {
    CreateProjectViewModel viewModel = context.read<CreateProjectViewModel>();
  ...
  Widget _body(BuildContext context, CreateProjectState state,
                    ...
                    if (!isCreateProject) ...[
                      ...
                      BoxLayout(
                        child: Column(
                          ...
                          children: [
                            CustomSectionHeader(
                                title: "project.createNewProject.contractors"
                                    .tr()),
                            const Gap(),
