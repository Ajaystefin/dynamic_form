...
class EditContractDraftHandler extends DraftHandler<EditContractViewModel> {
  ...
  /// Builds draft data for edit contract.
  @override
  ...
  /// Applies draft data to edit contract.
  @override
  void applyDraft(
    ...
    try {
      ...
      logger
        ..i(
          "EditContract draft applied for PPC=$restoredPpc",
        )
        // vm.loadPpcFromApi(restoredPpc);
        ..i(
