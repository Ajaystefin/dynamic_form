...
/// Helper methods for formatting, parsing, and validating project contract
...
class ProjectContractNumericHelper {
  ...
  /// Returns the provided string or an empty string when null.
  static String showStr(String? s) => s ?? "";

  /// Creates a compact input decoration with the provided [label].
  ...
  static String sanitizeString(Object? value) {
    if (value == null) {
      return "";
    }
  ...
  static String sanitizeDate(Object? value) {
  ...
  /// Returns a safe text value for display.
  ...
  /// Returns empty string for null, empty, or literal 'null' values.
  static String safeTextLower(Object? value) {
    if (value == null) {
      return "";
    }
    final s = value.toString().trim();
  ...
  /// (case-insensitive).
  static String sanitizeStringa(Object? value) {
    if (value == null) {
      return "";
    }
    final s = value.toString().trim();
  ...
  /// Safely converts dynamic (num or string) to double?
  static double? toDoubleOrNulla(Object? value) {
    if (value == null) {
      return 0;
    }
    if (value is double) {
  ...
  /// Parses PPC row string input into a double value.
...
// Strict DD/MM/YYYY checker
  ...
  /// Checks whether the input is a valid DD/MM/YYYY date.
...
// Returns "+1,234.000000", "-123.450000" or "NA" if ~0
  ...
  /// Formats signed numbers or returns NA for null or near-zero values.
...
// Computes variation (current AED - initial AED)
  ...
  /// Computes AED variation between current and initial values.
  static double? computeVariationAed({
    required double? initialAed,
    required double? currentAed,
  }) {
    if (initialAed == null || currentAed == null) {
      return null;
    }
...
// --- NEW: Safe string formatter that adds grouping without using double ---
  ...
  /// Adds thousands separators while preserving decimal places as typed.
...
// ---- Helper: format date as dd/MM/yyyy from int/String/DateTime/null ----
  ...
  /// Formats date values from int, string, DateTime, or null.
  static String fmtDateFromAny(Object? raw) {
    if (raw == null) {
      return "";
    }
    try {
  ...
  /// Converts a number to text without unnecessary trailing `.0`.
  ...
  static Decimal? toDecimalOrNull(Object? value) {
    if (value == null) {
      return null;
    }
    if (value is Decimal) {
  ...
  /// Returns the number of fully completed months between [start] and [end].
  ...
  /// Returns date-only value without time.
  static DateTime? dateOnly(DateTime? dt) =>
      dt == null ? null : DateTime(dt.year, dt.month, dt.day);

  /// Validates start and end dates using the provided year rules.
