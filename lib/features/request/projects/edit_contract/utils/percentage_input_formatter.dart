...
class PercentageInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    // Block "100." or "100.x"
    if (text.startsWith(ServerConstants.dot_100)) return oldValue;

    // If exactly "100" allow
    if (text == ServerConstants.max_100) return newValue;
    ...
    // Reject > 100
    if (value > ServerConstants.int_100) return oldValue;
...
TextInputFormatter createPercentageFormatter({
  ...
  return TextInputFormatter.withFunction(
    (oldValue, newValue) {
      ...
      if (!allowDecimal && text.contains(".")) return oldValue;
