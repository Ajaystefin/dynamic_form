...
/// Desktop view for the Relationship Utilization screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Relationship Utilization screen.
  ...
  Widget _body(
    ...
    RelationshipUtilizationState state,
  ...
  Widget _buildView(
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          const Gap(),
          RimListAccordion(viewModel: viewModel, state: state),
          const Gap(),
          Row(
