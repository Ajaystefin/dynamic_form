              ...
              CustomButton(
                  ...
                  onPressed: () async {
                    await viewModel.updateStrategiesComments(
                      newRelationshipStrategy:
                          viewModel.strategiesComments?.relationshipStrategy,
                      newDepositStrategy:
                          viewModel.strategiesComments?.depositStrategy,
                      newTransactionBankingComments: viewModel
                          .strategiesComments?.transactionBankingComments,
                      newTradeFinanceComments:
                          viewModel.strategiesComments?.tradeFinanceComments,
                      newTreasuryComments:
                          viewModel.strategiesComments?.treasuryComments,
                    );
                  }),
