...
/// Desktop view for the Business Volume screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Business Volume screen.
          ...
          children: [
            ...
            Row(
              ...
              children: [
                CustomButton(
                  semanticLabel:
                      "profitabilityAccountConduct.businessVolume.save".tr(),
                  label: "profitabilityAccountConduct.businessVolume.save".tr(),
                ...
                CustomButton(
                  semanticLabel: "profitabilityAccountConduct."
                          "businessVolume.saveAndContinue"
                      .tr(),
