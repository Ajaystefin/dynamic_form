...
class ViewDesktop extends StatelessWidget {
            ...
            Row(
              ...
              children: [
                CustomButton(
                    ...
                    onPressed: () async {
                      await viewModel.onSaveAndContinue(
                          viewModel.summaryComments, false,
                          context: context);
                    }),
                ...
                CustomButton(
                    ...
                    onPressed: () async {
                      await viewModel.onSaveAndContinue(
                          viewModel.summaryComments, true,
                          context: context);
                    }),
              ],
            ),
  ...
  Widget rarocInfoSection(viewModel) {
    return CustomAccordion(
      ...
      title:
          "profitabilityAccountConduct.relationshipProfitabilitySummary.rarocInformation"
              .tr(),
      children: [
        RoracInformation(
          viewModel: viewModel,
  ...
  Widget relationshipProfitabilitySection(viewModel) {
    return CustomAccordion(
      title:
          "profitabilityAccountConduct.relationshipProfitabilitySummary.relationshipProfitability"
              .tr(),
      children: [
  ...
  Widget relationshipProfitabilityGroupSection(viewModel) {
    ...
    return CustomAccordion(
      title: "Relationship Profitability Group Name- $groupName".tr(),
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            RelationshipProfitabilityGroup(viewModel: viewModel, index: 0),
          ],
        ),
      ],
    );
