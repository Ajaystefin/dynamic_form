...
/// RORAC information table.
class RoracInformation extends StatelessWidget {
  /// Creates a RORAC information table.
  ...
  List<List<Widget>> _tableRows(List<RarocInformation> rarocList) {
    ...
    return rarocList.isNotEmpty
        ? List.generate(rarocList.length, (index) {
            ...
            final bool hasFinalCtrl = viewModel.finalRarocControllers != null &&
            ...
            final bool isRestrictedRole = viewModel.otherRolesCheck();
              ...
              Center(
                child: hasRealizedCtrl
                    ? CustomTextField(
                        ...
                        readOnly: !viewModel.canEdit || isRestrictedRole,
                        filled: !viewModel.canEdit || isRestrictedRole,
                      )
                    : Text(
                        realizedRarocStr,
