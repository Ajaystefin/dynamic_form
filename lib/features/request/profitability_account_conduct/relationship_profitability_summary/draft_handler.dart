...
/// Draft handler for relationship profitability summary.
class RelationshipProfitabilitySummaryDraftHandler
  ...
  /// Builds draft data from relationship profitability summary view model.
  @override
  ...
  /// Applies draft data to relationship profitability summary view model.
  @override
  void applyDraft(
    RelationshipProfitabilitySummaryViewModel vm,
  ...
  Map<String, dynamic> _asStringDynamicMap(value) {
    if (value is! Map) {
      return <String, dynamic>{};
    }
