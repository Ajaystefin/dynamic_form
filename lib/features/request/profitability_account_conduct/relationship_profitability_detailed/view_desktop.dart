...
/// Desktop view for the Relationship Profitability Detailed screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Relationship Profitability Detailed screen.
            ...
            children: [
              CustomButton(
                ...
                onPressed: (viewModel.canEdit)
                    ? () async {
                        // Save the form to trigger onSaved
