...
/// Desktop view for the Share of Wallet screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Share of Wallet screen.
  const ViewDesktop({super.key});

  @override
  Widget build(BuildContext context) {
    final ShareOfWalletViewModel viewModel =
        context.read<ShareOfWalletViewModel>();
        ...
        return Form(
          ...
          child: Column(
            ...
            children: [
              ...
              if (viewModel.shareOfWalletList.isEmpty)
                Column(
                  children: [
                    Center(
                      child: Text("common.emptyState".tr()),
