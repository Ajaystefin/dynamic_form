...
/// Desktop view for the Account Conduct screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Account Conduct screen.
  const ViewDesktop({super.key});

  @override
  Widget build(BuildContext context) {
    final AccountConductViewModel viewModel =
        context.read<AccountConductViewModel>();
