...
class AccountConductViewModel extends SafeCubit<AccountConductState>
  ...
  /// Form key for account conduct form.
  ...
  /// Indicates whether current user has edit access.
  bool isEdit =
  ...
  void _initControllersFromCustomers() {
    for (int i = 0; i < customers.length; i++) {
      ...
      _ensureController(
        ...
        dto.passDueOrExcesses,
      );
      _ensureController("chequeReturns_$i", dto.chequeReturns);
      _ensureController("turnoverInAcc_$i", dto.turnoverInAcc);
      _ensureController("odHardcore_$i", dto.odHardcore);
      _ensureController(
        "unusualTransactions_$i",
        dto.unusualTransactions,
      );
      _ensureController(
