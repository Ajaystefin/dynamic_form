...
class AccountStatsViewModel extends SafeCubit<AccountStatsState>
  ...
  /// Creates an account stats view model.
  ...
  /// Customer-wise account stats.
  Map<Customer, List<AccountStat>> customerWiseAccountStat = {};

  /// Account stats comment.
  String? comment;

  /// Account stats comment data.
  Comment? commentData;
  ...
  /// Form key for account stats form.
  ...
  String getPreviousYearLabel(BuildContext context) {
    ...
    return "profitabilityAccountConduct.accountStats.previousYear".tr(
      namedArgs: {
  ...
  String getCurrentYearLabel(BuildContext context) {
    ...
    return "profitabilityAccountConduct.accountStats.currentYear".tr(
      namedArgs: {
