...
import "package:wcas_frontend/features/request/profitability_account_conduct/account_stats/widgets/action.dart";
import "package:wcas_frontend/features/request/profitability_account_conduct/account_stats/widgets/comments_field.dart";

/// Desktop view for the Account Stats screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop view for the Account Stats screen.
  const ViewDesktop({super.key});

  @override
  Widget build(BuildContext context) {
    final AccountStatsViewModel viewModel =
        context.read<AccountStatsViewModel>();
            ...
            child: BoxLayout(
              child: Column(
                ...
                children: [
                  CustomSectionHeader(
                    title:
                        "profitabilityAccountConduct.accountStats.sectionTitle"
                            .tr(),
                  ),
                  const Gap(),
                  BoxLayout(
                      ...
                      child: Column(
                        ...
                        children: [
                          const TabMenu(
                            ...
                            routes:
                                TabConstants.businessVolumeAccountStatsRoutes,
                            labels:
