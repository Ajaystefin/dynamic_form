...
class AccountStatsTable extends StatefulWidget {
  /// Creates an account stats table.
...
class _AccountStatsTableState extends State<AccountStatsTable> {
          ...
          stackedHeaders: [
            StackedHeader(
              ...
              widget: Text(
                ...
                widget.viewModel.getPreviousYearLabel(context),
              ),
            ),
            StackedHeader(
              width: 280.w,
              ...
              widget: Text(
                ...
                widget.viewModel.getCurrentYearLabel(context),
              ),
            ),
          ],
  ...
  /// Returns account stats table columns.
