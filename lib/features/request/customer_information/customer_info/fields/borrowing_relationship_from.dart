...
/// Borrowing relationship from field for the customer information screen.
class BorrowingRelationshipFromField extends StatelessWidget {
  /// Creates a borrowing relationship from field.
  ...
  Widget build(BuildContext context) {
    ...
    return LabelWidget(
      ...
      child: CustomTextField(
        ...
        filled: !viewModel.isBorrowingRelationshipEditable,
        readOnly: !viewModel.isBorrowingRelationshipEditable,
        onSaved: (value) {
...
/// Normalizes a date value into yyyy-MM-dd format when possible.
String? normalizeDateToIso(Object? value) {
  if (value == null) {
    return null;
  }
...
/// Safely parses a date string into dd/MM/yyyy format.
