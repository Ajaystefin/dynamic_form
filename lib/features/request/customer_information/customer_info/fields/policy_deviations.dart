...
/// Policy deviations multi-select field for the customer information screen.
class PolicyDeviations extends StatelessWidget {
  /// Creates a policy deviations field.
  ...
  Widget build(BuildContext context) {
    ...
    return LabelWidget(
      ...
      child: CustomMultiSelectDropdown<Reference>(
        ...
        selectedItems: viewModel.policyDeviation.where((opt) {
...
/// Iterable extension that returns distinct items by a selected key.
extension DistinctBy<T> on Iterable<T> {
  /// Returns iterable items with duplicate keys removed.
