...
class CountryOfRisk extends StatelessWidget {
  CountryOfRisk({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    return LabelWidget(
      isRequired: !viewModel.showCurrentFiCreditRisk,
      ...
      child: CustomMultiSelectDropdown<Country>(
        ...
        semanticLabel:  "customerInformation.customerInformation.countryOfRisk".tr(),
        isSearchable: true,
        isEnabled: true,
