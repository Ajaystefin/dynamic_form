...
/// Countries of business operation field for the customer information screen.
class CountriesOfBussinessOperationField extends StatelessWidget {
  /// Creates a countries of business operation field.
  CountriesOfBussinessOperationField({required this.viewModel, super.key});
  ...
  Widget build(BuildContext context) {
    return LabelWidget(
      ...
      child: CustomMultiSelectDropdown<Country>(
        ...
        semanticLabel: "customerInformation.customerInformation."
                "countryOfBussinessOperation"
            .tr(),
        isSearchable: true,
        validationMessage:  (viewModel.isFI) ? null : "common.validation.emptyField".tr(),
