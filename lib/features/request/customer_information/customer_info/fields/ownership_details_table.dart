...
/// Ownership details table for the customer information screen.
class OwnershipDetailsTable extends StatelessWidget {
  /// Creates an ownership details table.
    ...
    return LabelWidget(
      ...
      child: CustomRawTable(
        ...
        rows: List.generate(row?.length ?? 0, (index) {
          ...
          final bool isBackendZeroRim = !(owner.isNewlyAdded ?? false) &&
          ...
          viewModel
            ..ensureRimController(
              ...
              isNew: owner.isNewlyAdded ?? false,
            )
          ...
          final matches = viewModel.countries?.where(
            (c) =>
                c.description?.trim() == viewModel.residentCountryCode?.trim(),
          );
          ...
          return [
            /// ---------------- HAS RIM ----------------
            CustomCheckbox(
              isEnabled: viewModel.canEdit && !isBackendZeroRim,
              value: owner.hasRimInitialized
                  ? hasRimChecked
                  : ((owner.custOwnershipRim ?? 0) > 0),
              onChange: ({bool? value}) => (viewModel.canEdit)
                  ? viewModel.updateOwnershipRim(
                      index,
            ...
            CustomTextField(
              ...
              readOnly:
                  !viewModel.canEdit || !enableRimField || isBackendZeroRim,
              filled: !viewModel.canEdit || !enableRimField || isBackendZeroRim,
            ...
            CustomTextField(
              maxLength: 50,
              readOnly: !viewModel.canEdit || !enableOwnerNameField,
              filled: !viewModel.canEdit || !enableOwnerNameField,
            ...
            NationalityDropdown(
              ...
              isEnabled: viewModel.canEdit && enableOwnerNameField,
              onSelected: (c) => owner.nationality = c.description,
            ),
            ...
            CustomDropdown<String>(
              ...
              validationMessage: (viewModel.isFI)
                  ? null
                  : "customerInformation.customerInformation.selectResident"
                      .tr(),
            ),
