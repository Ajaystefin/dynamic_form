...
Widget browseUploadButtonWidget(BuildContext context,
    UploadDocumentDialogViewModel viewModel, UploadDocumentDialogState state) {
  return Row(mainAxisAlignment: MainAxisAlignment.end, children: [
    ...
    if (viewModel.selectedFiles.isNotEmpty)
      CustomButton(
          ...
          isLoading:
              state.uploadButtonStatus == LoadingStatus.loading ? true : false,
          onPressed: () {
