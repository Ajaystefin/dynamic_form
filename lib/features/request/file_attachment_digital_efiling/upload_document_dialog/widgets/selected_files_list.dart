  ...
  List<List<Widget>> _rows() {
    return viewModel.selectedDocuments
        ...
        .map((p) => [
              ...
              Text(viewModel.selectedDocuments[p.key].groupRim != null
                  ? viewModel.selectedDocuments[p.key].groupRim.toString()
                  : "N/A"),
              Text(viewModel.selectedDocuments[p.key].companyRim?.isNotEmpty ==
                      true
              ...
              Text(viewModel
                          .selectedDocuments[p.key].applicationId?.isNotEmpty ==
                      true
              ...
              Text(viewModel.selectedDocuments[p.key].language?.name ?? ""),
              Text(
              ...
              CustomTooltip(
                message:
                    viewModel.selectedDocuments[p.key].files?.isNotEmpty == true
