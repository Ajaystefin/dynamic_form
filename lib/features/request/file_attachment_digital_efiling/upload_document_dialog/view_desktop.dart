...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<UploadDocumentDialogViewModel,
        UploadDocumentDialogState>(builder: (context, state) {
      return _body(context, state, viewModel);
    });
  }

  Widget _body(BuildContext context, UploadDocumentDialogState state,
      UploadDocumentDialogViewModel viewModel) {
  ...
  Widget _buildView(BuildContext context, UploadDocumentDialogState state,
      UploadDocumentDialogViewModel viewModel) {
        ...
        child: Column(children: [
          ...
          if (viewModel.isConstitutionalDocumentsSelected() ||
            ...
            FormRow(children: [
              ...
              DocumentNameField(
                  isRequired: true,
                  initialValue: viewModel.documentName,
                  viewModel: viewModel,
          ...
          if (viewModel.isCreditLensSelected())
            FormRow(children: [
              SubTypeCreditLensField(
                label: "eDigitalFilingFileAttachments.fileAttachments.subType"
                    .tr(),
                viewModel: viewModel,
              ),
              ApplicationIdField(
          ...
          if (viewModel.isFinancialStatementsSelected()) ...[
            FormRow(children: [
              ...
              AttachmentLanguageField(
                viewModel: viewModel,
                label: "eDigitalFilingFileAttachments.fileAttachments.language"
                    .tr(),
              ),
              DocumentNameField(
                  isRequired: true,
