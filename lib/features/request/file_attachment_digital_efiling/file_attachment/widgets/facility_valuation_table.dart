...
class FacilityValuationWidget extends StatefulWidget {
  ...
  const FacilityValuationWidget({super.key, required this.documentData});
...
class _FacilityValuationWidgetState extends State<FacilityValuationWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomRawTable(
      ...
      rowModels: _getCommentRows(filteredData),
      rowsPerPage: 10,
      sortable: true,
    );
  }
  ...
  List<TableColumn> _getCommentColumns() {
    return [
      ...
      TableColumn(
          width: 250.w,
          label: Text(
              "eDigitalFilingFileAttachments.digitalEfiling.scanDate".tr())),
      TableColumn(
          width: 250.w,
          label:
  ...
  List<RowModel> _getCommentRows(List<dynamic> data) {
