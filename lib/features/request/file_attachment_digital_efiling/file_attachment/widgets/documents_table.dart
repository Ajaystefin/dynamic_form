...
Widget _buildFileTreeNode(FileAccess file) {
...
/// List of Widget to get Documents TableRows
  ...
  return [
    [
      SingleChildScrollView(
        child: _buildFileTreeNode(viewModel.fileAccesses[1]),
      ),
