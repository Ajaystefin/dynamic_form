                  ...
                  BoxLayout(
                    child: LabelWidget(
                      ...
                      child: Column(
                        children: [
                          SelectedFilesList(
                            key: const ValueKey("appendix_excel_files_list"),
                            viewModel: viewModel,
                  ...
                  BoxLayout(
                    child: LabelWidget(
                      ...
                      child: Column(
                        children: [
                          SelectedFilesList(
                            key: const ValueKey("appendix_image_files_list"),
                            viewModel: viewModel,
                          ...
                          // Optional: also show server-fetched images separately (if you want)
                          // SelectedFilesList(viewModel: viewModel, files: viewModel.bankFinancialFiles),
