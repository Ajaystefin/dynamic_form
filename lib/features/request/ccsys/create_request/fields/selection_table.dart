...
/// Displays a selectable customer table for CCSYS create request search results.
class SelectionTable extends StatefulWidget {
  /// Creates the customer selection table widget.
  ...
  /// View model used to provide customer data and selected customer state.
  final CcsysCreateRequestViewModel viewModel;

  /// Loader status used to render loading or loaded table state.
...
class _SelectionTableState extends State<SelectionTable> {
  ...
  /// Returns the column definitions for the customer selection table.
