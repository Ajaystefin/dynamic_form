...
/// Displays the customer selection dialog for CCSYS create request.
class SelectDialog extends StatelessWidget {
  /// Creates the customer selection dialog widget.
  const SelectDialog({required this.viewModel, super.key});

  /// View model used to manage customer search, filtering, and selection.
