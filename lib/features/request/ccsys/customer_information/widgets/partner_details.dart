...
/// Displays partner and shareholder details in an editable CCSYS table.
class PartnerDetails extends StatelessWidget {
  /// Creates the partner details table widget.
  ...
  /// View model used to manage partner details and table row actions.
  final CustomerInformationViewModel viewModel;

  /// Current customer information state used by partner details rules.
  ...
  /// Builds the partner and shareholder table rows.
    ...
    return List.generate(viewModel.rows.length, (index) {
      ...
      return [
        ...
        CustomDropdown<Reference>(
          ...
          selectedItems: [
            if (row.partnerShareholderResidence == null)
              null
            else
        ...
        CustomDropdown<Reference>(
          ...
          selectedItems: [
            if (row.partnerShareholderType == null)
              null
            else
        ...
        CustomDropdown<Reference>(
          ...
          selectedItems: [
            if (row.legalStatusOfPartnerShareholder == null)
              null
            else
        ...
        CustomDropdown<Reference>(
          ...
          selectedItems: [
            if (row.nationalityPartnerShareholder == null)
              null
            else
        ...
        CustomDropdown<Reference>(
          ...
          isSearchable: true,
          selectedItems: [
            if (row.placeIssueTradeLicenseNumberPartnerShareholder == null)
              null
            else
              viewModel.ccsysCountryList.firstWhere(
                (r) =>
  ...
  /// Builds the partner and shareholder table column definitions.
  List<TableColumn> getTableColumns() {
    // Pick an index to evaluate (e.g., 0) or compute anyRequired = rows.any(...)
    ...
    return [
      ...
      TableColumn(
        label: CcsysTootltip(
          message: "ccsys.customerInformation.tooltip.partnerTypeTooltip".tr(),
          child: addAsteriskIf(
            isRequired: true,
      ...
      TableColumn(
        label: CcsysTootltip(
          message:
              "ccsys.customerInformation.tooltip.partnerHoldingTooltip".tr(),
          child: addAsteriskIf(
            isRequired: true,
      ...
      TableColumn(
        label: CcsysTootltip(
          message: "ccsys.customerInformation.tooltip.partnerLegalStatusTooltip"
              .tr(),
          child: addAsteriskIf(
            isRequired: true,
      ...
      TableColumn(
        label: CcsysTootltip(
          message:
              "ccsys.customerInformation.tooltip.partnerNetworthTooltip".tr(),
          child: addAsteriskIf(
            isRequired: true,
      ...
      TableColumn(
        label: CcsysTootltip(
          message: "ccsys.customerInformation.tooltip.partnerPassportNumTooltip"
              .tr(),
          child: addAsteriskIf(
            isRequired: viewModel.rows.any(
              (r) =>
                  r.partnerShareholderResidence ==
      ...
      TableColumn(
        label: CcsysTootltip(
          message: "ccsys.customerInformation.tooltip.partnerTlNumTooltip".tr(),
          child: addAsteriskIf(
            isRequired: anyJP,
      ...
      TableColumn(
        label: CcsysTootltip(
          message:
              "ccsys.customerInformation.tooltip.partnerPlaceIssueTooltip".tr(),
          child: addAsteriskIf(
            isRequired: viewModel.rows.any(
      ...
      TableColumn(
        label: CcsysTootltip(
          message: "ccsys.customerInformation.tooltip.partnerPSLeiTooltip".tr(),
          child: addAsteriskIf(
            isRequired: anyJP,
      ...
      TableColumn(
        label: CcsysTootltip(
          message:
              "ccsys.customerInformation.tooltip.partnerLeiNumTooltip".tr(),
          child: addAsteriskIf(
            isRequired: viewModel.rows.any(
              (r) =>
                  r.legalStatusOfPartnerShareholder ==
      ...
      TableColumn(
        label: CcsysTootltip(
          message:
              "ccsys.customerInformation.tooltip.partnerGenderTooltip".tr(),
          child: addAsteriskIf(
            isRequired: true,
  ...
  /// Builds a unique key for partner detail table cells.
  Key eidCellKey(int i, String name) => ValueKey("${viewModel.rows[i]}-$name");

  /// Adds an asterisk to the given text when the field is required and editable.
