...
/// View model for the CCsys Termination / Withdrawal screen.
class CcsysTerminationViewModel extends SafeCubit<TerminationState>
    with DraftMixin<CcsysTerminationViewModel> {
  /// Creates a CCsys termination view model.
  ...
  /// Indicates whether termination was successful.
  ...
  /// Initializes user rights and page mode.
