...
/// Mobile view for the CCSYS request information screen.
class ViewMobile extends StatelessWidget {
  /// Creates a [ViewMobile] widget.
  const ViewMobile({super.key});

  /// Builds the mobile request information view.
  @override
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      CustomButton(
                                        isLoading:
                                            viewModel.state.isButtonLoading,
                                        label: "ccsys.requestInformation."
                                                "saveContinue"
                                            .tr(),
