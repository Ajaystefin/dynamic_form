...
/// Desktop view for the Guarantor Financial screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop guarantor financial view.
  ViewDesktop({super.key});

  /// Focus node used for entity search inputs.
  final FocusNode entityFocus = FocusNode();

  /// Focus node used for additional entity search inputs.
  ...
  /// Builds the main desktop view for the guarantor financial screen.
  Widget buildView(
