...
/// Handles draft persistence and restoration for the Financial
...
class FinancialRatioAnalysisDraftHandler
  ...
  Map<String, dynamic> buildDraftData(FinancialRatioAnalysisViewModel vm) {
    return {
      ...
      ///NOTE:-not required creating issues
  ...
  void applyDraft(
    ...
    // 1. Descriptions ///NOTE:-not required creating issues - required for description to be saved in draft and loaded back when user comes back to the screen
