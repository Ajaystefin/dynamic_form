...
/// Displays a recommendation dropdown for selecting a user and submitting
/// the selected approval action.
class RecommendationDropdown extends StatelessWidget {
  /// Creates a recommendation dropdown widget.
  ...
  /// Dropdown options grouped by role or category.
  ...
  /// View model used to manage selected user and submit action.
  final CommentsViewModel viewModel;

  /// User action to be submitted from this dropdown.
  final UserAction userAction;

  @override
  Widget build(BuildContext context) {
    final LayoutViewModel layoutViewModel = context.watch<LayoutViewModel>();
    // logger.i(" viewModel.userList : ${viewModel.userList.length}");
