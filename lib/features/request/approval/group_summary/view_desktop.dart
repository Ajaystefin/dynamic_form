...
/// Displays the desktop view for the group summary approval screen.
class ViewDesktop extends StatelessWidget {
  /// Creates the desktop group summary approval view.
        ...
        children: [
          LabelWidget(
            ...
            child: UnifiedTextEditor(
              ...
              characterLimit: 5000,
              // initialText: viewModel.comment?.strategyCategory ?? "",
              initialText: viewModel.initialText,
              editorId: "approval.groupSummary",
            ),
          ),
          const Gap(),
            ...
            Row(
              ...
              children: [
                CustomButton(
                  ...
                  onPressed: () {
                    viewModel.onSavePress(isContinue: false, context: context);
                  },
                ),
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    viewModel.onSavePress(isContinue: true, context: context);
                  },
                ),
              ],
            ),
