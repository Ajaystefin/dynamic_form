...
class CountrySummaryViewModel extends Cubit<CountrySummaryState> {
  /// Constructor initializes the state with a loading status.
  CountrySummaryViewModel()
      : super(const CountrySummaryState(loaderStatus: LoadingStatus.loading));
  ...
  void changeTab(CountrySummaryTabs tab) async {
  ...
  void navigate(BuildContext context) {
    ...
    for (MapEntry<CountrySummaryTabs, String> entry
