...
class ViewMobile extends StatelessWidget {
      ...
      return Layout(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              CustomSectionHeader(title: 'approval.countrySummary.title'.tr()),
              const Gap(),
              BoxLayout(
  ...
  Widget _body(BuildContext context, CountrySummaryState state,
  ...
  Widget _buildView(CountrySummaryViewModel viewModel, CountrySummaryTabs tab,
