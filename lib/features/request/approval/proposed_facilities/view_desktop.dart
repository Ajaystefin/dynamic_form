...
/// Displays the desktop view for the proposed facilities approval screen.
class ViewDesktop extends StatelessWidget {
  /// Creates the desktop proposed facilities approval view.
  ...
  Widget _buildView(ProposedFacilitiesViewModel viewModel) {
    return Column(
      children: [
        ...
        // Show Present Position Faclility only for individual application
