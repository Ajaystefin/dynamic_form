...
/// Displays the bottom action controls for the request for FOL screen.
class BottomControls extends StatelessWidget {
  /// Creates the bottom controls for request for FOL actions.
  ...
  /// View model used to manage request for FOL actions and visibility state.
    ...
    return FlexBox(
      ...
      children: [
        ...
        if (!viewModel.isReadOnly) ...[
          ...
          if (viewModel.buttonVisibilityStatus[
                          ApprovalFields.sendToDocumentation]!
                      .call() &&
          ...
          if (viewModel.buttonVisibilityStatus[ApprovalFields.sendToRORM]!
            ...
            CustomDropdownMenuButton(
              ...
              onButtonPressed: () =>
                  submitApplication(FOLTypeAction.sendToRoRm),
            ),
          if (viewModel
