...
/// Displays the desktop view for the queries and responses approval screen.
class ViewDesktop extends StatelessWidget {
  /// Creates the desktop queries and responses approval view.
  const ViewDesktop({super.key});

  @override
  Widget build(BuildContext context) {
    final QueriesAndResponsesViewModel viewModel =
  ...
  Widget _body(
    ...
    QueriesAndResponsesState state,
      ...
      children: [
        LabelWidget(
          ...
          child: UnifiedTextEditor(
            ...
            editorId: "approval.queries_and_responses",
          ),
        ),
