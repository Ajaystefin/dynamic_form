...
class GuarantorsExposureViewModel extends SafeCubit<GuarantorsExposureState> {
  ...
  GuarantorsExposureViewModel()
      : super(const GuarantorsExposureState(loaderStatus: LoadingStatus.loading));
  ...
  /// List of clean exposure records loaded for guarantors exposure.
  List<Exposure> exposureList = [];

  /// Clean exposure values mapped by RIM number.
  ...
  /// Loads clean exposure data and stores guarantor exposure values by RIM.
