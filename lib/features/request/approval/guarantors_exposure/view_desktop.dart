...
/// Displays the desktop view for the guarantors exposure approval screen.
class ViewDesktop extends StatelessWidget {
  /// Creates the desktop guarantors exposure approval view.
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          if (viewModel.guarantorList.isEmpty)
            Center(
              child: Text(
                "common.noData".tr(),
              ),
