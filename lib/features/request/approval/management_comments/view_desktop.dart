...
/// Displays the desktop view for the management comments approval screen.
class ViewDesktop extends StatelessWidget {
  /// Creates the desktop management comments approval view.
              ...
              if (!viewModel.isReadOnly)
                Row(
                  ...
                  children: [
                    ...
                    CustomButton(
                      label: "approval.managementComments.saveAndContinue".tr(),
                      semanticLabel:
                          "approval.managementComments.saveAndContinue".tr(),
                      onPressed: viewModel.canSubmit
                          ? () {
