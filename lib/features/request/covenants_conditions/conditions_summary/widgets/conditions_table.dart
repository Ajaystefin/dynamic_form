...
/// Conditions table widget for the conditions summary screen.
class ConditionsTableWidget extends StatelessWidget {
  ...
  List<List<Widget>> _getConditionsRows(BuildContext context) {
    ...
    return List.generate(viewModel.conditions.length, (index) {
      ...
      const int deleteAllowedActionId =ServerConstants.conditionActionCreateId;
      final bool shouldShowDeleteIcon =
          condition.action == deleteAllowedActionId;
      return [
