...
class ConditionsTableWidget extends StatelessWidget {
  ...
  const ConditionsTableWidget({super.key, required this.viewModel});
    ...
    return List.generate(viewModel.conditions.length, (index) {
      ...
      return [
        ...
        CustomTooltip(
          ...
          child: InkWell(
            onTap: viewModel.isViewOnlyMode
                ? null
                : () {
                    viewModel.showConditionCreate(context,
                        condition: condition);
                  },
            child: Padding(
        ...
        dynamicIcon(
          ...
          padding: 4,
          borderRadius: 4,
          onTap: (!viewModel.isViewOnlyMode & !viewModel.isReadOnlyMode)
              ? () async {
