...
class CustomerRimToBeTested extends StatelessWidget {
  ...
  const CustomerRimToBeTested({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    return LabelWidget(
      ...
      child: CustomDropdown<Customer>(
        ...
        // key: ValueKey(viewModel.customersList?.length ?? 0),
        key: ValueKey(
        ...
        itemBuilder: (context, item, _, isSelected) => dropdownItemBuildWidget(
