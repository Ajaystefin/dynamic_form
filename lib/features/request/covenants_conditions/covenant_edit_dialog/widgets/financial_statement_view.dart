          ...
          (linkcovenant.isStandard ?? true)
              ...
              : CustomTextArea(
                  ...
                  onChanged: (value) {
                    ...
                    // linkcovenant.description = value; // per-row, not VM
                  },
                ),
          FormRow(
            children: [
              FinancialCovenantTresholdType(
                viewModel: viewModel,
                row: linkcovenant, //  per-row
                isEnabled: (linkcovenant.isStandard ?? true) &&
                    viewModel.isRowThresholdEditable(linkcovenant),
                selectedItem:
