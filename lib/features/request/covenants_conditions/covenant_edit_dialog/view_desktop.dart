            ...
            children: [
              ...
              if (viewModel.selectedCovenantTypeEnum ==
                ...
                FinancialCovenantDescriptionField(
                  key: ValueKey(
                    "nf-std-desc-${viewModel.isFinancialStandard == true}",
                  ),
                  viewModel: viewModel,
                ...
                FormRow(
                  children: [
                    ...
                    if (viewModel.selectedCovenantTypeEnum ==
                        CovenantType.financial)
                      TresholdTypeField(
                        isEnabled: viewModel.isDesktopThresholdEditable,
                        viewModel: viewModel,
                      ),
                  ],
                ),
            ...
            FormRow(
              children: [
                CovenantDescriptionLinkFinancial(
                  key: ValueKey(
                    "desc-radio-${viewModel.isFinancialStandard == true}",
                  ), // NEW
                  viewModel: viewModel,
                ),
                FinancialSubtypeDropdownDesktop(
                  key: ValueKey(
                    "desktop-subtype-${viewModel.isFinancialStandard == true}",
                  ),
                  viewModel: viewModel,
                  forceEmptySelection: viewModel.isNewCovenant ||
                      !(viewModel.isFinancialStandard ?? true),
