...
class ViewMobile extends StatelessWidget {
  ...
  Widget _body(BuildContext context, CovenantsSummaryState state,
      CovenantsSummaryViewModel viewModel) {
  ...
  Widget _buildView(CovenantsSummaryState state,
      CovenantsSummaryViewModel viewModel, BuildContext context) {
    return Form(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              const Gap(),
              AddItemButton(
                onTap: () async => await viewModel.showCovenantCreate(context),
                isLeftSided: true,
                child: Text(
