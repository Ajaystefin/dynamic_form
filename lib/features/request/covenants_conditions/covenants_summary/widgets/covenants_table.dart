...
/// Covenant table widget for the covenants summary screen.
class CovenantTableWidget extends StatelessWidget {
  /// Creates a covenant table widget.
  const CovenantTableWidget({required this.viewModel, super.key});

  /// Covenants summary view model.
    ...
    return List.generate(viewModel.covenant.length, (index) {
      ...
      return [
        ...
        CustomTooltip(
          ...
          sideOverlayOffset: const Offset(150, -8),
          sideOverlayWidth: 340,
  ...
  /// Formats an API date string for UI display.
