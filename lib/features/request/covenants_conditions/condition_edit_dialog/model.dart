...
/// View model for the condition edit dialog.
class ConditionEditDialogViewModel extends SafeCubit<ConditionEditDialogState> {
  /// Creates a condition edit dialog view model.
  ...
  /// Form key used by the condition edit dialog.
  ...
  /// Indicates whether the dialog is updating an existing condition.
  ...
  /// Indicates whether status and action fields can be edited.
  bool get canEditStatusAction => _allowStatusActionEditing && canEdit;

  /// Selected general or specific field value.
  ...
  /// Indicates whether the condition should be included in term sheet.
  bool includeInTermField = false;

  /// Page mode for the dialog.
  PageMode pageMode = PageMode.na;

  /// Page mode used for condition edit permissions.
  PageMode? conditionEditPageMode;

  /// Indicates whether the dialog can be edited.
  bool get canEdit =>
      conditionEditPageMode == PageMode.edit; // && Utils.canEditApplication();
  ...
  bool get canEditComments =>
      ...
      conditionEditPageMode != PageMode.na;

  /// Customer list used by the customer name dropdown.
  ...
  /// Indicates whether the action field is editable.
  ...
  /// Returns the description subtypes for the selected condition type.
    ...
    if (isSpecificSelected()) {
      final data = await DialogHelper.showCustomDialog(
        ...
        content: SelectFacilitiesDialogView(
          ...
          overridePageMode: conditionEditPageMode,
        ),
        context: context,
      );
  ...
  /// Gets the selected status field value.
  Reference get statusFieldChanged => selectedStatus!;

  /// Sets the selected status field value.
  set statusFieldChanged(Reference data) {
    selectedStatus = data;
  }

  /// Sets the selected facility list.
  ...
  /// Returns action values excluding create action.
