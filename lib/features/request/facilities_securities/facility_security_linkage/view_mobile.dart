...
/// Mobile layout for displaying and managing the facility-security
/// linkage screen.
class ViewMobile extends StatelessWidget {
  /// Creates a mobile facility-security linkage view.
  const ViewMobile({
    super.key,
  });
  ...
  /// Builds the main facility-security linkage mobile view.
  Widget buildView(
    FacilitySecurityLinkageViewModel viewModel,
    FacilitySecurityLinkageState state,
    BuildContext context,
