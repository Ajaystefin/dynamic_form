...
/// Desktop layout for displaying and managing the facility-security
/// linkage screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop facility-security linkage view.
  const ViewDesktop({
    super.key,
  });
  ...
  Widget _body(
    ...
    FacilitySecurityLinkageState state,
  ...
  /// Builds the main facility-security linkage view.
  Widget buildView(
    FacilitySecurityLinkageViewModel viewModel,
    FacilitySecurityLinkageState state,
    BuildContext context,
