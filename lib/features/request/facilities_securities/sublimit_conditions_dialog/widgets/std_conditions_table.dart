...
/// Widget for displaying standard conditions associated with a
/// sub-limit.
class SublimitStdConditionsTable extends StatelessWidget {
  /// Creates a sub-limit standard conditions table widget.
  const SublimitStdConditionsTable({
    required this.viewModel,
    super.key,
  });

  /// View model containing sub-limit condition data and actions.
              ...
              return <Widget>[
                ...
                Center(
                  child: CustomCheckbox(
                    isEnabled:
                        !(viewModel.standardConditions[index].isWaivedOff ??
                            false),
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          CustomCheckbox(
                            isEnabled: !(viewModel
                                    .standardConditions[index].isWaivedOff ??
                                false),
                            value:
                                viewModel.standardConditions[index].isAmended,
                            onChange: ({bool? value}) {
...
/// Widget that displays editable multi-line text content.
///
/// Allows users to edit the full text value and submit the updated
/// content through the provided callback.
class MultiEditableText extends StatefulWidget {
  /// Creates a multi-editable text widget.
  ...
  /// Text style applied to the displayed content.
  final TextStyle? style;

  /// Indicates whether text editing is enabled.
  final bool enabled;

  /// Callback invoked when the edited text is submitted.
...
///
/// A segment can be either regular text or a placeholder value
...
class ParsedPart {
  ...
  /// Indicates whether this segment originated from a placeholder.
...
///
/// Placeholders are identified by square brackets (for example,
/// `[Customer Name]`). The returned list preserves the original
/// order of text and placeholder parts.
