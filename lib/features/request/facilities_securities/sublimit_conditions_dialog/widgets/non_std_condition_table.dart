...
/// Widget for displaying non-standard conditions defined for a
/// sub-limit.
class SublimitNonStdConditionTable extends StatelessWidget {
  /// Creates a sub-limit non-standard conditions table widget.
    ...
    return Column(
      ...
      children: [
        CustomRawTable(
          ...
          columns: columns,
          rowHeight: 80,
          rows: List.generate(viewModel.nonStandardConditions.length, (index) {
            return [
              if ((viewModel.nonStandardConditions[index].isAmended ?? false) ||
                  (viewModel.nonStandardConditions[index].isShowAsTextField ??
                      false))
                CustomTextField(
                  readOnly:
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        CustomCheckbox(
                          isEnabled: !(viewModel
                                  .nonStandardConditions[index].isWaivedOff ??
                              false),
                          value: viewModel
                                  .nonStandardConditions[index].isAmended ??
                              false,
                          onChange: ({value}) {
