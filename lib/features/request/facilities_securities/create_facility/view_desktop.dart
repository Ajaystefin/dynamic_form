        ...
        return BoxLayout(
          ...
          child: Column(
            ...
            children: [
                ...
                FormRow(
                  children: [
                    CommonCurrencyConvertField(
                      viewModel: viewModel,
                      textController: viewModel.newPresentOutStandingController,
                    ),
                    const SizedBox(),
                    const SizedBox(),
                  ],
              ...
              FormRow(
                children: [
                  (viewModel.showNewPresentLimitAmount)
                      ? CommonCurrencyConvertField(
                          viewModel: viewModel,
                          textController: viewModel.newPresentLimitController,
                        )
                      : const SizedBox(),
                  (viewModel.showNewProposedLimitAmount)
                      ? CommonCurrencyConvertField(
                          viewModel: viewModel,
                          textController: viewModel.newProposedLimitController,
                        )
                      : const SizedBox(),
                  (viewModel.showNewProposedByCCAmount)
                      ? CommonCurrencyConvertField(
                          viewModel: viewModel,
                      ...
                      children: [
                        (viewModel.showNewRevisedBankLimitProposedByFiAmount)
                            ? CommonCurrencyConvertField(
                                viewModel: viewModel,
                                textController:
                                    viewModel.newProposedLimitController,
                              )
                            : const SizedBox.shrink(),
                        showFiProp
                            ? CommonCurrencyConvertField(
                  ...
                  children: [
                    (viewModel.showNewCbdEquityTier325PercentAmount)
                        ? CommonCurrencyConvertField(
                            viewModel: viewModel,
                            textController:
                                viewModel.newCbdEquityTier325PercentController,
                          )
                        : const SizedBox.shrink(),
                    (viewModel.showNewCounterpartyEquity5PercentAmount)
                        ? CommonCurrencyConvertField(
                            ...
                            textController: viewModel
                                .newCounterpartyEquity5PercentController,
                          )
                        : const SizedBox.shrink(),
                    (viewModel.showNewCounterpartyTotalAssets2PercentAmount)
                        ? CommonCurrencyConvertField(
                            viewModel: viewModel,
                            textController: viewModel
                                .newCounterpartyTotalAssets2PercentController,
                          )
                        : const SizedBox.shrink(),
                  ],
                ),
