            ...
            itemBuilder: (context, i) {
              return Padding(
                ...
                child: CustomAccordion(
                  title:
                      "Jhone Doe - 23986", // UI purpose only. need to place with proper data once API fixed
                  children: List.generate(
                    ...
                    (index) => CustomAccordionTitleWidget(
                      ...
                      children: [
                        ...
                        const Gap(),
                        if (viewModel.facility.facilityTypeSelectedValue !=
                                null &&
        ...
        return SectionBackground(
          child: Column(
            ...
            children: [
              ...
              const Gap(),
              viewModel.facility.selectedRegulatorySpecialisedLandingValue
                          ?.id ==
              ...
              const Gap(),
              // DynamicForm(  //TODO uncomment after fix API issue
