...
/// Widget for displaying and managing facility seniority information.
class FacilitySeniority extends StatelessWidget {
  /// Creates a facility seniority widget.
  const FacilitySeniority({
    required this.viewModel,
    super.key,
  });

  /// View model containing facility seniority data and actions.
