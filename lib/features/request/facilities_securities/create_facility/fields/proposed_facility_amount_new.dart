...
class ProposedFacilityAmountNew extends StatelessWidget {
  final CreateFacilityViewModel viewModel;
  const ProposedFacilityAmountNew({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    ...
    return CustomTextField(
      ...
      controller: viewModel.newProposedFacilityAmountController,
      readOnly: true,
      filled: true,
      initialValue: '0',
      inputFormatters: [
      ...
      onChanged: (String? value) {
        if (value != null && value.isNotEmpty) {
          ...
          // viewModel.facility.proposedLimit = double.tryParse(cleaned);

          // Format for display
          String formatted = formatter.format(int.parse(cleaned));
          viewModel.newProposedFacilityAmountController.value = TextEditingValue(
            text: formatted,
