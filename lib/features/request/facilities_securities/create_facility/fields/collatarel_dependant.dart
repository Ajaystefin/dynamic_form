...
/// Widget for managing the collateral dependant selection.
class CollateralDepandant extends StatelessWidget {
  /// Creates a collateral dependant selector.
  const CollateralDepandant({required this.viewModel, super.key});

  /// View model containing collateral dependant data and actions.
