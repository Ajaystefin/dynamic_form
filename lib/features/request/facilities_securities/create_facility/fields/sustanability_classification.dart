...
/// Widget for displaying and managing sustainability classification details.
class SustanabilityClassification extends StatelessWidget {
  /// Creates a sustainability classification widget.
  const SustanabilityClassification({
    required this.viewModel,
    super.key,
  });

  /// View model containing sustainability classification data and actions.
