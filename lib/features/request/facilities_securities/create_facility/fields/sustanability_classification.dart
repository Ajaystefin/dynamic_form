...
class SustanabilityClassification extends StatelessWidget {
  ...
  const SustanabilityClassification({super.key, required this.viewModel});
  ...
  Widget build(BuildContext context) {
    ...
    return LabelWidget(
      ...
      child: CustomMultiSelectDropdown(
        ...
        // selectedItems: selectedRefs.isEmpty ? null : selectedRefs,
        ...
        onSelected: (value) {
          viewModel.facility.sustainabilityClassification = value;
        },
      ),
    );
  }
