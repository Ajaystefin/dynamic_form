...
/// Widget for displaying and managing limit caps description details.
class LimitCapsDescription extends StatelessWidget {
  /// Creates a limit caps description widget.
  const LimitCapsDescription({
    required this.viewModel,
    super.key,
  });

  /// View model containing limit caps description data and actions.
