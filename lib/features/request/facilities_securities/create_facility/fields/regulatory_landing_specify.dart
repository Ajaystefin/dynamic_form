...
/// Widget for displaying and managing regulatory lending specification details.
class RegulatoryLandingSpecification extends StatelessWidget {
  /// Creates a regulatory lending specification widget.
  const RegulatoryLandingSpecification({
    required this.viewModel,
    super.key,
  });

  /// View model containing regulatory lending specification data and actions.
