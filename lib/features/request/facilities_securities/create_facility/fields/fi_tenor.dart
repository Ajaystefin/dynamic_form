...
/// Widget for displaying and managing FI tenor information.
class FiTenor extends StatelessWidget {
  /// Creates a FI tenor widget.
  const FiTenor({required this.viewModel, super.key});

  /// View model containing FI tenor data and actions.
  final CreateFacilityViewModel viewModel;

  @override
  Widget build(BuildContext context) {
    final bool isRequired =
        ServerConstants.generalTradeGroup == viewModel.getFacility.limitGroup ||
