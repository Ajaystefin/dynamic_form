...
int? _toInt(dynamic id) => (id is num) ? id.toInt() : int.tryParse("$id");

int? _mapGroupId(int? typeId) {
  if (typeId == 14492) return 11312; // General
  if (typeId == 14493) return 11317; // Stand-by
  if (typeId == 14494) return 11315; // Specific
  return null;
}
