...
/// Widget for displaying and managing promissory note information.
class PromissoryNote extends StatelessWidget {
  /// Creates a promissory note widget.
  const PromissoryNote({required this.viewModel, super.key});

  /// View model containing promissory note data and actions.
  ...
  Widget build(BuildContext context) {
    ...
    final Reference selected = viewModel.facilityDetail.isNotEmpty
        ? (viewModel.facilityDetail.first.promissoryNoteTaken ?? false
            ? yesRef
            : noRef)
