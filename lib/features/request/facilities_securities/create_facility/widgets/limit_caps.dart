...
/// Widget for displaying and managing limit cap entries.
class LimitCaps extends StatelessWidget {
  /// Creates a limit caps widget.
  const LimitCaps({
    required this.viewModel,
    super.key,
  });

  /// View model containing limit cap data and actions.
                ...
                children: [
                  CustomButton(
                    ...
                    onPressed: viewModel.isApiError
                        ? null
                        : () {
                            viewModel.saveSingleBorrowerLimitCaps(
                ...
                children: [
                  CustomButton(
                    ...
                    onPressed: viewModel.isApiError
                        ? null
                        : () {
                            viewModel.saveGroupBorrowerLimitCaps(
                              navigateToHomePage: false,
                            );
                          },
                  ),
...
/// Returns the column definitions for the project allocation table.
...
/// Builds the project allocation table rows for the available customers.
///
/// Each row displays:
/// - Customer RIM number
/// - Original company cap
/// - Present company cap
/// - Proposed company cap allocation
///
/// The allocation value is updated in the view model when the user
/// modifies the corresponding field.
