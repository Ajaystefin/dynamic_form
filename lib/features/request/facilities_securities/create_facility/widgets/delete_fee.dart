...
/// Widget for deleting a fee entry.
class DeleteFeeButton extends StatelessWidget {
  /// Creates a delete fee button widget.
  ...
  /// View model containing fee management data and actions.
  final CreateFacilityViewModel viewModel;

  /// Identifier of the fee to be deleted.
  final int? feeID;
