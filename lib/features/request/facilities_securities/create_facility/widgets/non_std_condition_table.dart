        ...
        CustomRawTable(
          ...
          rows: List.generate(viewModel.nonStandardCondition.length, (index) {
            return [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        CustomCheckbox(
                          isEnabled: !(viewModel
                                  .nonStandardCondition[index].isWaivedOff ??
                              false),
                          value:
                              viewModel.nonStandardCondition[index].isAmended ??
                                  false,
                          onChange: (value) {
              ...
              Center(
                child: Visibility(
                  visible: viewModel.canDeleteNonStandardCondition(index),
                  child: IconButton(
                    tooltip: "Delete",
                    icon: const Icon(
                    ...
                    onPressed:
                        (viewModel.nonStandardCondition[index].isWaivedOff ??
                            ...
                            ? null
                            : () {
                                viewModel.removeNonStandardCondition(index);
                              },
                  ),
                ),
              ),
