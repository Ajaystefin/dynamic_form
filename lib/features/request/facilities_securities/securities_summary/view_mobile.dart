...
/// Mobile layout for displaying and managing the securities summary
/// screen.
class ViewMobile extends StatelessWidget {
  /// Creates a mobile securities summary view.
  const ViewMobile({
    super.key,
  });
  ...
  /// Builds the main securities summary view for mobile devices.
  Widget buildView(
    SecuritiesSummaryViewModel viewModel,
    BuildContext context,
    SecuritiesSummaryState state,
    ...
    return SingleChildScrollView(
      child: BoxLayout(
        child: Column(
          ...
          spacing: 10,
          children: [
            CustomSectionHeader(title: "security.securitySummary.title".tr()),
            BoxLayout(
