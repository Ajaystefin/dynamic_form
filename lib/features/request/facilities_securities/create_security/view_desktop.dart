...
import "package:wcas_frontend/features/request/facilities_securities/create_security/fields/present_security_amount_readonly.dart";
import "package:wcas_frontend/features/request/facilities_securities/create_security/fields/proposed_security_amount.dart";
import "package:wcas_frontend/features/request/facilities_securities/create_security/fields/proposed_security_amount_readonly.dart";
                    ...
                    BoxLayout(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FormRow(
                            children: [
                              (viewModel.showPresentSecurityAmount)
                                  ? PresentSecurityAmountReadOnly(
                                      viewModel: viewModel,
                                    )
                                  : const SizedBox(),
                              (viewModel.showProposedSecurityAmount)
                                  ? ProposedSecurityAmountReadOnly(
                                      viewModel: viewModel,
                                    )
                                  : const SizedBox(),
                              const SizedBox(),
                          ...
                          if (viewModel.sections.isNotEmpty)
                            DynamicForm(
                              ...
                              // allow editing ONLY CMO-flagged fields
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (viewModel.canEdit || viewModel.isCmoUpdate())
                                Align(
