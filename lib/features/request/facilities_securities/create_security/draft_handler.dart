...
class CreateSecurityDraftHandler extends DraftHandler<CreateSecurityViewModel> {
  ...
  void applyDraft(
    ...
    security
      ...
      ..securityProviderAddress = data["securityProviderAddress"] as String? ??
    ...
    security
      ...
      ..proposedSecurityAmount = data["proposedSecurityAmount"] as double? ??
    ...
    security
      ...
      ..allFacilities = data["allFacilities"] as bool? ?? security.allFacilities
