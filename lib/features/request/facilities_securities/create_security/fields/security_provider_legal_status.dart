...
/// Widget for displaying and managing the security provider legal status.
class SecurityProviderLegalStatus extends StatelessWidget {
  /// Creates a security provider legal status widget.
  const SecurityProviderLegalStatus({
    required this.viewModel,
    super.key,
  });

  /// View model containing security provider legal status data and actions.
    ...
    return LabelWidget(
      ...
      child: CustomDropdown<Reference>(
        ...
        onSelected: (selectedValue) {
          viewModel.security.securityProviderLegalStatus = selectedValue.first;
        },
