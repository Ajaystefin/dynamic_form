...
import "package:wcas_frontend/features/request/facilities_securities/others_limit_dialog/fields/segment_field.dart";
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Expanded(child: SegmentField(viewModel: viewModel)),
