...
/// Widget for adding or editing a facility sub-limit.
///
/// Provides the configuration and context required to create a new
/// sub-limit or manage an existing one.
class AddFacilitySubLimitBox extends StatelessWidget {
  /// Creates an add facility sub-limit widget.
  ...
  /// Display label for the dialog or section.
  final String? label;
  ...
  /// Indicates the selected limit type.
                        ...
                        child: CustomButton(
                          ...
                          onPressed: (viewModel.facility.facilityDescription !=
                              ...
                              ? () async {
                                  ...
                                  final bool isProjGroup = gid ==
                                          ServerConstants
                                              .projectSpecificLimitsID ||
                                      gid ==
                                  ...
                                  if (isOthersSelected) {
                                    await DialogHelper.showCustomDialog(
                                      ...
                                      title:
                                          "facilities.facilitySummary.addProduct"
                                              .tr(),
