...
/// Widget for displaying overall facility totals across all groups.
///
/// Presents aggregated limit amounts and summary information for the
/// selected customer.
class OverallTotalTable extends StatelessWidget {
  /// Creates an overall total table widget.
  ...
  /// Customer whose aggregated facility totals are displayed.
  final FacilitySummaryList customer;

  /// Index used to retrieve the corresponding group data.
  ...
  /// Builds the rows displayed in the overall totals table.
  ///
  /// Returns aggregated totals for existing limits, proposed limits,
  /// and variance information for the selected customer.
...
/// Returns the column definitions for the overall totals table.
///
/// Configures columns for existing limits, proposed limits,
/// and limit variance information.
