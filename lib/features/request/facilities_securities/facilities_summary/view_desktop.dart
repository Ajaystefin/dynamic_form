...
/// Desktop layout for displaying and managing the facility summary screen.
class ViewDesktop extends StatelessWidget {
  /// Creates a desktop facility summary view.
  const ViewDesktop({
    super.key,
  });
  ...
  /// Builds the desktop view using the provided view model and state.
  Widget buildView(
    FacilitiesSummaryViewModel viewModel,
    FacilitiesSummaryState state,
    BuildContext context,
