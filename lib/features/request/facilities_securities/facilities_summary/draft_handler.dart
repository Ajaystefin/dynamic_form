...
/// Draft handler responsible for saving and restoring facility summary
/// draft data.
///
/// Persists edited facility information, selected limit details,
/// project-specific values, standby values, and header currency
/// selections.
class FacilitySummaryDraftHandler
    extends DraftHandler<FacilitiesSummaryViewModel> {
  /// Returns the unique draft key used to identify facility summary drafts.
