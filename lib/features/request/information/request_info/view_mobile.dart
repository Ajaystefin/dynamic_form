...
/// Mobile view for the Request Information screen.
///
/// Provides a mobile-optimized layout for displaying and managing
/// request information on smaller devices.
class ViewMobile extends StatelessWidget {
  ...
  Widget _buildBodySection(
    ...
    final bool canShowButton = viewModel.canEdit || viewModel.otherRolesCheck();
    //viewModel.canEdit  ? viewModel.otherRolesCheck() :
    return Focus(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (!Utils.checkApplicationType(
                          ...
                          if (state.isApplicationTypeMarkForward)
                            MarkForwardDate(
                              viewModel: viewModel,
                              state: state,
                            )
                          ...
                          const Gap(),
                          if (state.isInterimReviewDateRequired)
