...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RequestInfoViewModel viewModel = context.read<RequestInfoViewModel>();
  ...
  Widget _body(BuildContext context, RequestInfoState state,
  ...
  Widget _buildBodySection(BuildContext context, RequestInfoState state,
      RequestInfoViewModel viewModel) {
    return Focus(
      ...
      child: Form(
        ...
        child: BoxLayout(
          child:
            ...
            CustomSectionHeader(
              title:
                  "requestInformation.requestInformation.requestInformationTitle"
                      .tr(),
            ),
            const Gap(),
            Column(
                ...
                BoxLayout(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(),
                      // Second Row: Business Segment, Region, Branch (3 Columns)
                      FormRow(
                        children: [
                      ...
                      const Gap(),
                      // Third Row: Application Type (Single Widget, Empty Columns)
                      FormRow(
                        children: [
                          ...
                          viewModel.selectedApplicationType?.id ==
                              ...
                              : viewModel.selectedApplicationType?.id ==
                                      ServerConstants
                                          .applicationTypeReconsiderationId
                      ...
                      if (viewModel.selectedApplicationType == null ||
                          viewModel.selectedApplicationType?.id !=
                              ServerConstants.applicationTypeCancelId) ...[
                        // Widgets to show when 'Reconsideration' is selected
                        // These widgets will show ONLY when Reconsideration' is selected
                        ...
                        FormRow(
                          children: [
                            ...
                            //InterimReviewDateRequired is Yes show InterimReviewDate
                        ...
                        if (viewModel.canEdit &&
                          ...
                          AddItemButton(
                            ...
                            isLeftSided: true,
                            child: Text(
                              'requestInformation.requestInformation.addOtherCoBorrowers'
                                  .tr(),
                      ...
                      if (viewModel.canEdit)
                        Row(
                          ...
                          children: [
                            CustomButton(
                                label:
                                    "requestInformation.requestInformation.saveContinue"
                                        .tr(),
