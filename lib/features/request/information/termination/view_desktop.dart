...
/// Desktop view for the Termination screen.
///
/// Displays termination details, review information, comments,
/// and action controls using a desktop-optimized layout.
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TerminationViewModel viewModel = context.read<TerminationViewModel>();
