...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    PresentRequestViewModel viewModel = context.read<PresentRequestViewModel>();
  ...
  Widget _body(BuildContext context, PresentRequestState state,
    ...
    switch (state.loaderStatus) {
      ...
      default:
        return _buildWidgets(viewModel, state);
    }
  }

  Widget _buildWidgets(
      PresentRequestViewModel viewModel, PresentRequestState state) {
