...
/// Displays the non-borrowers table on the Group Borrowers screen.
///
/// Presents customers who are not currently included as borrowers
/// and supports reviewing or selecting them for inclusion in the
/// request when applicable.
class NonBorrowersTable extends StatelessWidget {
  /// Creates a [NonBorrowersTable].
