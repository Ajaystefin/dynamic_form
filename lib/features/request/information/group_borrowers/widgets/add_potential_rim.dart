...
/// Displays the section used to add customer RIMs to the request.
///
/// Provides the user interface for entering, searching, and managing
/// customer RIM information during the request creation process.
class AddRimSection extends StatelessWidget {
  /// Creates an [AddRimSection].
                ...
                children: [
                  ...
                  CustomButton(
                    ...
                    onPressed: viewModel.canAddPotentialBorrower
                        ? () {
                            viewModel.addPotentialBorrower(context: context);
                          }
                        : null, // disabled state
                  ),
