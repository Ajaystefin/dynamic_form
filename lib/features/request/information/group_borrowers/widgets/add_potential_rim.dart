...
class AddRimSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String rimInput = viewModel.addRimInput ?? "";
    return BoxLayout(
            ...
            Row(
              children: [
                Flexible(
                  fit: FlexFit.loose,
                  child: LabelWidget(
                    label: "requestInformation.groupBorrowers.customerRim".tr(),
                    isRequired: true,
                    child: CustomTextField(
                      width: AppStyle.groupBorrowersTextField,
                      initialValue: viewModel.rim,
                      maxLength: 15,
                      inputFormatters: [
                ...
                const Gap(
                    direction: Axis.horizontal), // stays the same fixed gap
                Flexible(
                  fit: FlexFit.loose,
                  child: LabelWidget(
                    label:
            ...
            Row(
              ...
              children: [
                CustomButton(
                    ...
                    onPressed: () {
                      String rimValue = viewModel.addRimInput?.trim() ?? '';
                      String nameValue =
                          viewModel.customerNameController.text.trim();
                      viewModel.searchedCustomerRim = rimValue;
                      viewModel.searchedCustomerName = nameValue;
