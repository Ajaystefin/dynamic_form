...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ApplicationBorrowersViewModel,
        ApplicationBorrowersState>(builder: (context, state) {
      return Layout(
  ...
  Widget _body(BuildContext context, ApplicationBorrowersState state,
      ApplicationBorrowersViewModel viewModel) {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              CustomSectionHeader(
                  title:
                      "requestInformation.applicationBorrowers.borrowersPartOfTheApplication"
                          .tr()),
              ...
              Column(
                ...
                children: [
                  ...
                  const BoxLayout(
                    child: BorrowersPartOfTheApplication(),
                  ),
                ],
              ),
              const Gap(),
