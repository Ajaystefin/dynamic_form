...
/// Desktop view for the Security Perfection feature.
                ...
                children: [
                  ...
                  BoxLayout(
                    ...
                    child: Column(
                      spacing: AppStyle.spacing,
                      children: [
                        SecurityPerfectionTable(viewModel: viewModel,state: state),
                        const Gap(),
                        CovenantTable(viewModel: viewModel,state: state),
                        const Gap(),
                        ConditionTable(viewModel: viewModel,state: state),
                        const Gap(),
                          ...
                          Align(
                            ...
                            child: CustomButton(
                              ...
                              label: "requestInformation."
                                      "securityPerfection.saveContinue"
                                  .tr(),
                            ),
                          ),
                      ],
