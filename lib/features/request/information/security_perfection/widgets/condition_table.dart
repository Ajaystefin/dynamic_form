...
class ConditionTable extends StatelessWidget {
  ...
  const ConditionTable({super.key, required this.viewModel});
    ...
    return LabelWidget(
      ...
      child: CustomRawTable(
        ...
        columns: [
          ...
          TableColumn(
              label: Text(
                  "requestInformation.securityPerfection.conditionNumber"
                      .tr())),
          TableColumn(
              label: Text(
                  "requestInformation.securityPerfection.conditionDescription"
                      .tr())),
          TableColumn(
              label: Text(
                  "requestInformation.securityPerfection.conditionDeferral"
                      .tr())),
        ],
