...
/// Displays action controls related to customer or request selection.
///
/// Provides actions that allow users to confirm, update, or navigate
/// through the selection process during request creation.
class SelectionActionWidgets extends StatelessWidget {
  /// Creates a [SelectionActionWidgets].
  const SelectionActionWidgets({
    required this.viewModel,
    super.key,
  });

  /// View model that manages the Create Request screen state
  /// and handles selection-related actions.
