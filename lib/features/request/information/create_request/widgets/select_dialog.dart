...
import 'package:wcas_frontend/features/request/information/create_request/fields/selection_table.dart';
...
class SelectDialog extends StatelessWidget {
  const SelectDialog({super.key, required this.viewModel});
                            ...
                            child: TextfieldWithButton(
                                ...
                                validator: (value) {
                                  return CustomValidator.requiredFieldCustomMsg(
                                      value,
                                      "common.validation.pleaseEnter".tr() +
                                          "requestInformation.createRequest.customerName"
                                              .tr());
                                },
                                inputFormatters: [
                                  LengthLimitingTextInputFormatter(50)
