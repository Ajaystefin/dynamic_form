...
/// Displays the Customer Type field used during request creation.
///
/// The field is bound to the provided [CreateRequestViewModel] and
/// allows users to view or select the customer type associated
/// with the request.
class CustomerTypeField extends StatelessWidget {
  /// Creates a [CustomerTypeField].
