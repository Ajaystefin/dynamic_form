...
/// Displays the Application Type field used during request creation.
///
...
class ApplicationTypeField extends StatelessWidget {
  /// Creates an [ApplicationTypeField].
  const ApplicationTypeField({
    required this.viewModel,
    super.key,
  });

  /// View model that provides data and handles interactions
  /// for the Application Type field.
