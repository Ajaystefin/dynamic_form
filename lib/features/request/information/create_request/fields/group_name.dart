...
/// Displays the Group Name field used during request creation.
///
/// The field is bound to the provided [CreateRequestViewModel] and
/// allows users to enter or view the group name associated with
/// the request.
class GroupNameField extends StatelessWidget {
  /// Creates a [GroupNameField].
  GroupNameField({
  ...
  Widget build(BuildContext context) {
    return TextfieldWithButton(
      ...
      isRequired: true,
      value: viewModel.valueTruncateToMax(viewModel.groupName, 50),
      viewModel: viewModel,
      maxLength: 50,
