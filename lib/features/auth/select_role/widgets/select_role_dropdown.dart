...
/// Dropdown section used for selecting a user role.
class SelectRoleDropdown extends StatelessWidget {
  /// Creates a [SelectRoleDropdown].
  ...
  /// View model that manages role selection.
  final SelectRoleViewModel viewModel;

  /// Current state of the select role screen.
  final SelectRoleState state;

  /// Optional width of the dropdown section.
  final double? width;
        ...
        children: [
          ...
          CustomDropdown<Role>(
            ...
            itemBuilder: (context, item, {isDisabled, isSelected}) => Ink(
              color:
                  isSelected ?? false ? AppColors.primary : AppColors.darkBlue,
