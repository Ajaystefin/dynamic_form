...
///
/// Handles saving, retrieving, and deleting per-screen draft data from
/// the backend. Uses the singleton pattern for shared access across
/// the application.
class DraftRepository {
  /// Creates a [DraftRepository] instance.
  ///
  ...
  /// Returns the singleton instance of [DraftRepository].
  ...
  static set overrideInstance(DraftRepository newInstance) {
  ...
  /// Deletes a saved draft for the specified module and screen.
  ///
  /// Removes the draft associated with the current application, module,
  /// and screen from the backend storage.
  ///
