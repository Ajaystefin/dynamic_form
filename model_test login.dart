...
void main() {
  ...
  group('LoginViewModel Tests', () {
    ...
    test('Empty username validation', () {
      String? result = CustomValidator.email("");
      expect(result, 'common.validation.emptyEmail'.tr());
    });

    test('Invalid email format', () {
      String? result = CustomValidator.email("invalid-email");
      expect(result, 'common.validation.invalidEmail'.tr());
    });

    test('Valid username validation', () {
      String? result = CustomValidator.email("email@email.com");
      expect(result, null);
    });

    test('Empty password validation', () {
      String? result = CustomValidator.password("");
      expect(result, 'common.validation.emptyPassword'.tr());
    });

    test('Valid password validation', () {
      String? result = CustomValidator.requiredField("passwordm");
      expect(result, null);
    });
  });
}
