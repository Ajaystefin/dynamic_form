...
class ViewDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    LimitCapsViewModel viewModel = context.read<LimitCapsViewModel>();
  ...
  Widget _body(BuildContext context, LimitCapsState state,
  ...
  Widget _buildView(LimitCapsViewModel viewModel) {
    return Column(children: [
      ...
      const Gap(),
      if (viewModel.filteredlimitDetail.isEmpty) Text('common.emptyState'.tr()),
      const Gap(),
      Row(
        // spacing: 10,
