...
class ViewDesktop extends StatelessWidget {
  ...
  Widget _body(BuildContext context, RequestForClosureState state,
      RequestForClosureViewModel viewModel) {
  ...
  Widget _buildView(BuildContext context, RequestForClosureState state,
      RequestForClosureViewModel viewModel) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      LabelWidget(
        ...
        child: CustomTextArea(
          ...
          semanticLabel: "approval.requestForClosure.remarkJustification".tr(),
          maxLength: 5000,
        ...
        Align(
          ...
          child: CustomButton(
            ...
            onPressed: viewModel.canSubmit
                ? () {
                    viewModel.saveComment(ifNavigate: false);
                  }
                : null,
          ),
        ),
