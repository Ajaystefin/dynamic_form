    ...
    return LabelWidget(
      ...
      child: viewModel.isFIFlow && viewModel.cmoRemarksController != null
          ? UnifiedTextEditor(
              ...
              initialText: viewModel.security.cmoRemarks ?? '',
              disable: viewModel.isApproved || !viewModel.isCmoUpdate(),
              height: 300,
              editorId:
                  'security_cmo_remarks_${viewModel.security.securityId ?? 'new'}',
              scrollController: viewModel.scrollController,
            )
          : CustomTextArea(
              initialValue: viewModel.security.cmoRemarks,
              filled: viewModel.isApproved || !(viewModel.isCmoUpdate()),
              maxLength: 1000,
              readOnly: viewModel.isApproved,
