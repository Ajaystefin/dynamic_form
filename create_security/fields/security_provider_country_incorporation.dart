...
class SecurityProviderCountryIncorporation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ignore: avoid_print
    print("coI ${viewModel.countryOfIncorporation ?? [].isEmpty}");
    return LabelWidget(
      label: ((viewModel.security.securityType?.id ==
      ...
      child: CustomDropdown<Country>(
        isEnabled: (!viewModel.securityProviderCbdCustomer ||
            ...
            viewModel.countryOfIncorporation!.isEmpty &&
        ...
        selectedItems: viewModel.security.securityProvidedCountry != null
            ? [viewModel.security.securityProvidedCountry]
            : viewModel.didPrefillCountryFromRim &&
                ...
                : viewModel.isSecurityProviderCbdCustomerNo
                    ? viewModel.countries
                        .where((country) =>
                            country.description ==
                            ServerConstants.aedDescription)
                        .toList()
                    : [],
