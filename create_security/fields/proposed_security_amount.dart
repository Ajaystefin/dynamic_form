    ...
    return LabelWidget(
      ...
      isEnabled:
          ...
          (viewModel.security.securityType?.id !=
              ...
              // Enabled for Insurances only when Pari-passu is false; otherwise enabled for other types by default
              &&
              (viewModel.security.securityType?.id !=
        ...
        readOnly: viewModel.isCmoUpdate() ||
            !((viewModel.security.securityType?.id !=
                ...
                (viewModel.security.securityType?.id !=
                    ...
                    !viewModel.isParipassu)),
        initialValue:
            (viewModel.security.proposedSecurityAmount ?? 0).toString(),
        inputFormatters: [
        ...
        prefixIcon: CustomDropdown<Reference>(
          ...
          onSelected: (selectedValue) {
            if (selectedValue.isNotEmpty) {
              ...
              viewModel.getCurrencyRates(selectedValue.first, false);
            }
          },
