...
import 'package:wcas_frontend/features/request/facilities_securities/create_security/fields/present_security_amount_new.dart';
                        ...
                        children: [
                          ...
                          FormRow(
                            children: [
                              (viewModel.showPresentSecurityAmount)
                                  ? PresentSecurityAmountNew(
                                      viewModel: viewModel)
                                  : const SizedBox(),
                              (viewModel.showProposedSecurityAmount)
                                  ? ProposedSecurityAmountNew(
                                      viewModel: viewModel)
                                  : const SizedBox(),
                              const SizedBox(),
                            ],
                          ...
                          if (!(viewModel.security.securityType?.id ==
                              ...
                              viewModel.security.securityType?.id ==
                                  ServerConstants.personalGuaranteeId ||
                              viewModel.security.securityType?.id ==
                                  ServerConstants.financialGuranteeID)) ...[
                            FormRow(children: [
