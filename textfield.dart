...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  void initState() {
    ...
    if (widget.controller == null) {
      ...
      // seed the controller with that text once, but only if the controller is empty.
  ...
  Widget build(BuildContext context) {
    return
        ...
        //   label: widget.semanticLabel ?? widget.hintText ?? widget.labelText ?? 'text',
        ...
        ValueListenableBuilder<String?>(
            ...
            builder: (context, errorText, _) {
              return CustomTooltip(
                message: onChangeValue ??
                    (widget.showToolTip ? (errorText ?? "") : ""),
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    validator: (String? value) {
                      ...
                      if (widget.validator == null &&
                          (widget.readOnly || (value?.isNotEmpty ?? false))) {
                    ...
                    maxLength:
                        (widget.maxLength ?? 0) > 0 ? widget.maxLength : null,
                    ...
                    decoration: InputDecoration(
                      ...
                      fillColor: widget.readOnly
                          ...
                          : widget.fillColor,
                      isDense: true,
                      border: _getBorder(errorText),
                      // focusedBorder: _getBorder(errorText),
                      enabledBorder: _getBorder(errorText),
                      errorBorder: _getBorder(errorText),
                      focusedErrorBorder: _getBorder(errorText),
