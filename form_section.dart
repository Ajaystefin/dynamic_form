        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Example: Search TextField with debounce and loading indicator
              CustomTextField(
                showToolTip: false,
                semanticLabel: "Search Example",
                textStyle: const TextStyle(
                    color: AppColors.white, fontSize: AppStyle.fontSizeLarge),
                labelText: 'Search Items (Example)',
                useUnderlineBorder: true,
                labelStyle: const TextStyle(
                    color: AppColors.darkGrey,
                    fontSize: AppStyle.fontSizeLarge),
                ...
                // Debounce duration (default is 500ms, here we set 800ms)
                searchDebounce: const Duration(milliseconds: 800),
                // Show loading indicator while searching (default is true)
