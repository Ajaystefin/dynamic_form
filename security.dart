...
class Security {
  ...
  factory Security.fromJson(
    ...
    return Security(
      ...
      securityProvidedCountry: countries?.firstWhere(
        (country) => country.code == json['securityProviderCountry'],
        orElse: () => Country(),
      ),
      countryOfSecurity: json['countryOfSecurity'],
      emirates: emirates?.firstWhere(
        (emirate) => emirate.id.toString() == json['emirate'],
      ),
      securityStatus: statuses?.firstWhere(
  ...
  Map<String, dynamic> toJson() {
    ...
    data['securityCode'] = securityType?.reference3 ?? "";
    ...
    data['otherNameOfZone'] = dynamicFormDocument?['enterOtherNameOfZone'];
    ...
    data['securityProviderCountry'] = securityProvidedCountry?.code;
    data['countryOfSecurity'] =
        countryOfSecurity ?? ServerConstants.aedCurrency;
    ...
    data['countryIncorporation'] = ServerConstants.aedDescription;
