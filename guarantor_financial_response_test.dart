...
void main() {
  group('GuarantorFinancialDetailsResponse', () {
    ...
    test('toJson should serialize correctly', () {
      final response = GuarantorFinancialDetailsResponse(
        guarantorFinancialsId: 999,
        appRefNo: 'APP003',
        rimNo: 111,
        customerName: 'Serialized Guarantor',
        guarantorFinancialsComment: 'Serialized Comment',
        entityDetails: [],
        createdBy: 'creator',
      ...
      expect(json['guarantorFinancialsId'], 999);
      expect(json['appRefNo'], 'APP003');
      expect(json['rimNo'], 111);
      expect(json['customerName'], 'Serialized Guarantor');
      expect(json['guarantorFinancialsComment'], 'Serialized Comment');
