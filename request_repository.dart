...
// SAVE SICcode
  ...
  Future<Security?> getSecurityDetails({Security? selectedSecurity}) async {
    Security? security;
    Map data = BaseRequest.baseRequest({
      ...
      "rimNo": int.tryParse(selectedSecurity?.securityProvidedRim ?? ""),
      "facilitySecurityMasterId": selectedSecurity?.facilitySecurityMasterLinkId
    });
