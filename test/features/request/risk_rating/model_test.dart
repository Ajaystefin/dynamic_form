...
/// ViewModel subclass that simulates FI flow with proposed-by-credit editable
class FiFlowProposedEditableViewModel extends RiskRatingViewModel {
  @override
  bool isProposedbyCreditEditables() => true;
}

/// ViewModel subclass simulating FI flow where user is not proposed-by-credit
/// editable
class FiFlowNonEditableViewModel extends RiskRatingViewModel {
  @override
  bool isProposedbyCreditEditables() => false;
}
...
void main() {
  ...
  group("add/remove external table row", () {
    ...
    test("removeExternalTableRow marks normal row as deleted before removal",
      ...
      viewModel.riskRating = RiskRating(
        externalRatings: [
          ExternalRating(customerRimNo: 123, isDeleted: false),
          ExternalRating(customerRimNo: 456),
        ],
        internalRatings: [],
      );
    ...
    test("isExternalDuplicate returns true for null rim when null exists", () {
      viewModel.riskRating = RiskRating(
        externalRatings: [
          ExternalRating(customerRimNo: null),
        ],
        internalRatings: [],
      );
  ...
  group("add/remove internal table row", () {
    ...
    test("removeInternalTableRow throws when id is not found", () {
      viewModel.riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRiskRatingId: 1, customerRimNo: 123),
        ],
        externalRatings: [],
      );

      expect(
        () => viewModel.removeInternalTableRow(999),
  ...
  group("duplicate helpers", () {
    ...
    test("isInternalDuplicate ignores rows where customerRimNo is null", () {
      viewModel.riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRimNo: null, entityId: 1),
        ],
        externalRatings: [],
      );
    ...
    test(
      ...
      expect(viewModel.isInternalDuplicate(rim: 100, entityId: null), false);
    });
  ...
  group("multipleEntities helper", () {
    ...
    test("multipleEntities with null customerRimNo", () {
      viewModel.updatedRiskRating = [
        UpdatedRating(rimNo: 123, entityId: 1),
        UpdatedRating(rimNo: null, entityId: 2),
      ];
    ...
    test("multipleEntities preserves null entity values for matching rim", () {
      viewModel.updatedRiskRating = [
        UpdatedRating(rimNo: 100, entityId: null),
    ...
    test("multipleEntities returns all matching entity IDs including nulls",
        () {
      viewModel.updatedRiskRating = [
        UpdatedRating(rimNo: 200, entityId: null),
        UpdatedRating(rimNo: 200, entityId: null),
  ...
  group("getRiskRating", () {
    ...
    test("getRiskRating adds multiple rims with no entities", () async {
      final riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRimNo: 111, entityId: null, entities: []),
          InternalRating(customerRimNo: 222, entityId: null, entities: null),
        ],
        externalRatings: [],
      );
    ...
    test(
      ...
      final riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRimNo: 100, entityId: 5, entities: null),
        ],
        externalRatings: [],
      );
  ...
  group("onSelectedEntities", () {
    testWidgets(
        "onSelectedEntities returns early when "
    ...
    testWidgets(
      ...
      when(
        () => mockRepo.getUpdatedRatingDetails(rimNo: null, entityId: 15),
      ...
      verify(() => mockRepo.getUpdatedRatingDetails(rimNo: null, entityId: 15))
          .called(1);
    ...
    test(
      ...
      viewModel.riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRimNo: 777, entityId: null),
        ],
        externalRatings: [],
      );
    ...
    test(
      ...
      viewModel.riskRating = RiskRating(
        internalRatings: [
          InternalRating(customerRimNo: 111, entityId: null),
          InternalRating(customerRimNo: 222, entityId: null),
        ],
        externalRatings: [],
      );
  ...
  group("fetchCustomerIfrs", () {
    test(
      ...
      when(
        ...
        (_) async => Customer(id: "100", ifrsStaging: null),
      );
