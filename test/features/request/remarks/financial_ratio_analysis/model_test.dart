...
class TestFinancialRatioAnalysisViewModel
  ...
  final UnifiedEditorController _controller =
      UnifiedEditorController.fromController(StubHtmlEditorController());

  @override
  UnifiedEditorController get balanceSheetcontroller => _controller;
  @override
  UnifiedEditorController get cashflowController => _controller;
  @override
  UnifiedEditorController get incomeStatementController => _controller;
  @override
  UnifiedEditorController get descTextController => _controller;
}
...
void main() {
  ...
  group("helpers & formatters", () {
    test("getConstValue bounds & trimming and unqualified prefix", () {
      ...
      // expect(vm.getConstValue(0, 0), ServerConstants.unqualified);
    });
    ...
    test(
      ...
      // Add a saved row
      final savedRow = IncomeStatementAnalysisRow(id: "74")
      ...
      final savedRow2 = IncomeStatementAnalysisRow(id: "74")
    ...
    test("deleteUserAddedCashflowRow handles success and failure", () async {
      ...
      vm.cashflowSheetRows.add(
        CashFlowSheetAnalysisRow(id: "75")..cashFlowItems = "Saved",
      );
    ...
    test("deleteUserAddedBalanceRow handles success and failure", () async {
      ...
      vm.balanceSheetRows.add(
        BalanceSheetAnalysisRow(id: "76")..balanceSheet = "Saved",
      );
  ...
  group("onSavePress", () {
    test("handles save error gracefully", () async {
      ...
      await testVm.onSavePress(isContinue: false, MockBuildContext());
  ...
  group("dateFromSaved", () {
    ...
    test("clamps period greater than 12 months to December", () {
      ...
      expect(result, DateTime(2020, 12));
    });
  ...
  group("buildStatementsFromSavedValues", () {
    ...
    test("falls back to period-based date when statementDate is invalid", () {
      ...
      expect(result.first.date, DateTime(2021, 6));
    });
  ...
  group("mkIncomeRowFromSaved", () {
    ...
    test("uses unavailable text when value is null", () {
      final items = [
        fv(year: 2021, period: "12 months", ratioType: "COGS"),
      ];
  ...
  group("mkCashflowRowFromSaved", () {
    ...
    test("uses unavailable text when matched value is null", () {
      final items = [
        fv(year: 2021, period: "12 months", ratioType: "FREE_CF"),
      ];
  ...
  group("valuesFromRow", () {
    ...
    test("maps columns to financial values correctly", () {
      ...
      expect(result[0].auditor, "E&Y");

      expect(result[1].value, 200);
      expect(result[1].auditMethod, "Unaudited");
