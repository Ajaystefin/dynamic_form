...
void main() {
  ...
  setUp(() async {
    ...
    viewModel = GuarantorsExposureViewModel()..repository = repo;
  ...
  test("onSavePress without continue does not throw", () {
    expect(
      () => viewModel.onSavePress(FakeBuildContext()),
      returnsNormally,
    );
  });
  ...
  test("GuarantorsExposureState constructor and copyWith work", () {
    const state = GuarantorsExposureState(loaderStatus: LoadingStatus.loaded);
