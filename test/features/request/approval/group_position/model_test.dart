...
void main() {
  ...
  group("updateExposureField()", () {
    test(
      ...
      () async {
        viewModel
          ..updateExposureField(1, "10", "200", isProposed: false)
          ..updateExposureField(2, "0", "700", isProposed: false);
    ...
    test(
      ...
      () async {
        viewModel
          ..updateExposureField(1, "10", "500", isProposed: true)
          ..updateExposureField(2, "0", "1000", isProposed: true);
        expect(viewModel.groupedExposure.length, 2);
      },
    );
  });
  ...
  group("GroupPositionState", () {
    test("constructor sets loaderStatus", () {
      const state = GroupPositionState(loaderStatus: LoadingStatus.loading);
      expect(state.loaderStatus, LoadingStatus.loading);
    });

    test("copyWith keeps existing when null", () {
      const original = GroupPositionState(loaderStatus: LoadingStatus.loaded);
