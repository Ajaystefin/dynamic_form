...
void main() {
  ...
  group("applicationTypeItems", () {
    ...
    test("corporate path – filters by corperateCode + requestType.ref1", () {
      final vm = RequestInformationViewModel();
      vm.selectedRequestType = _ref(id: 1, name: "New", ref1: "NEW");
      vm.selectedBusinessSegment = _ref(
        id: ServerConstants.businessSegmentId[BusinessSegment.corporate] ?? 999,
        name: "Corp",
      );
      vm.applicationType = [
        _ref(
    ...
    test("empty when requestType.ref1 does not match", () {
      final vm = RequestInformationViewModel();
      vm.selectedRequestType = _ref(id: 1, name: "X", ref1: "NOMATCH");
      vm.selectedBusinessSegment = _ref(id: 1, name: "Corp");
      vm.applicationType = [
        _ref(
          id: 1,
          name: "A",
    ...
    test("null reference3 does not crash", () {
      final vm = RequestInformationViewModel();
      vm.selectedRequestType = _ref(id: 1, name: "N", ref1: "NEW");
      vm.selectedBusinessSegment = _ref(id: 1, name: "Corp");
      vm.applicationType = [
    ...
    test("null selectedBusinessSegment falls through to corporate path", () {
      final vm = RequestInformationViewModel();
      vm.selectedRequestType = _ref(id: 1, name: "N", ref1: "NEW");
      vm.selectedBusinessSegment = null;
      vm.applicationType = [
        _ref(
          id: 1,
          name: "A",
  ...
  group("field mutability", () {
    ...
    test("selectedLastApprovedAppRefNum nullable", () {
      final vm = RequestInformationViewModel();
      vm.selectedLastApprovedAppRefNum = "REF-X";
