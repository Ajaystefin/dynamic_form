...
void main() {
  ...
  setUp(() {
    ...
    LocalStorageService().getStorage = mockLocalStorage;
    ...
    test("Large dataset filter sanity (performance smoke)", () async {
      final items = List<Request>.generate(
        ...
        (i) => Request(
          ...
          customerRimNo: i,
          applicationType:
              i.isEven ? Reference(name: "Loan") : Reference(name: "Credit"),
        ),
      );
    ...
    test(
      ...
      () async {
        await viewModel.onFilter(
          ...
          selectedTypes: [
            Request(
              requestSubType: Reference(name: "Credit"),
            ),
          ],
        ...
        expect(viewModel.closedRequestFilteredData.length, 0);
        // expect(
        //   viewModel.closedRequestFilteredData.first?.requestSubType?.name,
        //   null,
        // );
      },
    );
