...
void main() {
  ...
  group("getApplicationDetails", () {
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Application not found")),
      );
    });
  });
  ...
  group("getCustomerRequestInfo", () {
    test("should successfully get customer request info", () async {
      Globals.user = buildUser(roleCode: "ADMIN");
    ...
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Request Info Error")),
      );
    });
  });
  ...
  group("getPipelineRequestDetails", () {
    test("should return empty list on success with empty responseData",
        () async {
      Globals.request = buildRequest(groupId: 42, customerRimNo: 777);
    ...
    test("should throw exception when API fails", () async {
      ...
      expect(
        ...
        throwsA(equals("Error fetching pipeline details")),
      );
    });
  });
  ...
  group("updateTerminateStatus", () {
    ...
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Terminate update failed")),
      );
    });
  });
  ...
  group("getCertificateDetails", () {
    ...
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Certificate details error")),
      );
    });
  });
  ...
  group("saveCertificateDetails", () {
    ...
    test("should throw when save fails", () async {
      ...
      expect(
        ...
        throwsA(equals("Save certificate failed")),
      );
    });
  });
  ...
  group("getSecurityDetails", () {
    ...
    test(
      ...
      expect(
        ...
        throwsA(equals("Create flow failed")),
      );
  ...
  group("saveGroupFacilitiesWithCbd", () {
    ...
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Group facility save failed")),
      );
    });
  });
  ...
  group("getFacilitiesOtherBanks", () {
    ...
    test("should throw when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Facilities other bank error")),
      );
    });
  });
  ...
  group("getFacilitiesCentralRiskBureau", () {
    ...
    test("should throw when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Risk bureau error")),
      );
    });
  });
  ...
  group("saveFacilitiesWithOtherBank", () {
    ...
    test("should throw when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Save facilities failed")),
      );
    });
  });
  ...
  group("getApplicationBorrowers", () {
    ...
    test("should throw exception when API returns error", () async {
      ...
      expect(
        ...
        throwsA(equals("Borrowers fetch failed")),
      );
    });
  });
  ...
  group("getCurrencyCodes", () {
    ...
    test("should throw exception when API status is error", () async {
      ...
      expect(
        ...
        throwsA(equals("Currency fetch failed")),
      );
    });
  });
  ...
  group("deleteFeeStructureData", () {
    ...
    test("should throw exception when delete fails", () async {
      ...
      expect(
        ...
        throwsA(equals("Delete failed")),
      );
    });
  });

  group("getUsersByRoles", () {
    test("should return flattened list of users when responseData is valid",
        () async {
      Globals.user = buildUser(
        segments: ["CORP", "SME"],
        regions: ["DXB", "AUH"],
      ...
      final result = await requestRepository.getUsersByRoles(["RM", "CAD"]);

      expect(result, isA<List<User>>());
      expect(result, hasLength(3));
      expect(
        mockAPIManager.callLog.first["endpoint"],
        equals(APIEndpoints.getUsersByRoles),
      );
      expect(mockAPIManager.callLog.first["method"], equals("POST"));
    });
    ...
    test("should return empty list when responseData is null", () async {
      ...
      final result = await requestRepository.getUsersByRoles(["RM"]);

      expect(result, isEmpty);
    });

    test("should throw when response status is error", () async {
      Globals.user = buildUser();
      ...
      expect(
        () async => requestRepository.getUsersByRoles(["RM"]),
        throwsA(equals("Users fetch failed")),
      );
    });
  });
}
