  ...
  group("ProfitabilityRepository", () {
    ...
    group("getShareOfWallet", () {
      test("success with list maps to ShareOfWallet list", () async {
        // TODO: Adjust keys to match ShareOfWallet.fromJson
        api.setMockResponse(
          AppResponse(
            status: ResponseStatus.success,
            code: 200,
    ...
    group("getIncomeSummary", () {
      test("success with valid map returns parsed model", () async {
        // TODO: Adjust JSON to match IncomeSummaryResponseData.fromJson
        api.setMockResponse(
          AppResponse(
            status: ResponseStatus.success,
            code: 200,
    ...
    group("saveIncomeSummary", () {
      test("success returns statusDescription", () async {
        ...
        // TODO: Build a minimal IncomeSummary your model accepts
      ...
      test("error throws message", () async {
        ...
        expect(() => repo.saveIncomeSummary([], null), throwsA("bad"));
      });
    });
    ...
    group("postAccountConductData", () {
      test('success returns statusDescription or "Success"', () async {
        ...
        // TODO: Build AccountConductResponseData minimal instance
      ...
      test("error throws message", () async {
        ...
        expect(() => repo.postAccountConductData(model), throwsA("nope"));
      });
    });
    ...
    group("getRelationshipUtilizationData", () {
      test("success returns mapped list", () async {
        // TODO: Align JSON to your RelationshipUtilization.fromJson
        api.setMockResponse(
          AppResponse(
            status: ResponseStatus.success,
            code: 200,
    ...
    group("getRelationProfitDetData", () {
      test("success returns list from incomeSummaryDataList", () async {
        // TODO: Align JSON keys with your
    ...
    group("getComments", () {
      ...
      test("error throws message", () async {
        ...
        expect(() => repo.getComments(), throwsA("no"));
      });
    });
    ...
    group("getBusinessVolumes", () {
      ...
      test("error status throws", () async {
        ...
        expect(() => repo.getBusinessVolumes(), throwsA("fail"));
      });
    ...
    group("saveBusinessVolumes", () {
      ...
      test("exception path throws wrapped error", () async {
        ...
        expect(
          ...
          throwsA(contains("Failed to save business volumes:")),
        );
        api.setMockException(null);
      });
    });
    ...
    group("getAccountStats", () {
      test("success builds Map<Customer, List<AccountStat>>", () async {
        // TODO: Adjust JSON to match AccountStat.fromJson & Customer.fromJson
        api.setMockResponse(
          AppResponse(
            status: ResponseStatus.success,
            code: 200,
      ...
      test("error throws message", () async {
        ...
        expect(() => repo.getAccountStats(), throwsA("no"));
      });
    });
    ...
    group("getRelationshipProfitabilitySummaryData", () {
      test("success returns model", () async {
        // TODO: Align JSON shape to RelationshipProfitabilitySummary.fromJson
        api.setMockResponse(
          AppResponse(
            status: ResponseStatus.success,
            code: 200,
      ...
      test("invalid responseData throws", () async {
        ...
        expect(
          () => repo.getRelationshipProfitabilitySummaryData(),
          throwsA("Invalid response: responseData missing or not an object"),
        );
      });
    });
