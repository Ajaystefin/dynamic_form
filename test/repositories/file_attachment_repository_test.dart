...
void main() {
  group("FileAttachmentRepository Integration Tests", () {
    ...
    group("Dependency Injection", () {
      ...
      test("should make mocks and fake selected doc fields reachable", () {
        final fileDownloadService = MockFileDownloadService();
        final fileSaver = MockFileSaver();

        expect(fileDownloadService, isA<MockFileDownloadService>());
        expect(fileSaver, isA<MockFileSaver>());

        final doc = FakeSelectedDoc(
          edmsDriveItemId: "1",
          webUrl: "http://test",
          rimNo: "RIM123",
          date: DateTime(2024),
        ...
        expect(doc.edmsDriveItemId, "1");
        expect(doc.webUrl, "http://test");
        expect(doc.rimNo, "RIM123");
        expect(doc.date, DateTime(2024));
        expect(doc.groupId, "G1");
      });
    });
    ...
    group("getFileUploadData", () {
      ...
      test("should throw error message on failure", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error occurred"),
        );
      });
    });
    ...
    group("getDocuments", () {
      test("should return list of Document on success", () async {
        ...
        final result = await fileAttachmentRepository.getDocuments(
          showApprovalSubType: false,
          documentTypes: <Reference>[],
          subTypes: <Reference>[],
          subSubTypes: <Reference>[],
          subSubSubTypes: <Reference>[],
          languages: <Reference>[],
        );
      ...
      test("should throw error message on failure", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Failed to get documents"),
        );
      });
    });
    ...
    group("getCompanyRims", () {
      ...
      test("should throw error message on failure", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Failed to get rims"),
        );
      });
    });
    ...
    test("downloadFileAttachment failure", () async {
      ...
      await expectLater(
        ...
        throwsExceptionWithMessage("Download failed"),
      );
    });
...
//     test("uploadDocumentsMultipart success - empty document list", () async {
//       Globals.request = Request(applicationRefNo: "TEST123");
...
//       expect(result, isNotNull);
//       expect(result, contains("0 files have been uploaded successfully."));
// });

    test("uploadDocumentsMultipart handles multiple documents - all success",
        () async {
      Globals.request = Request(applicationRefNo: "TEST123");
    ...
    test("deleteDocument failure", () async {
      ...
      expect(
        ...
        throwsExceptionWithMessage("Deleted failed"),
      );
    });
    ...
    test("zipDownloadDigitalAttachment sucess", () async {
      ...
      final List<DocSubTypeData?> docs = [
        DocSubTypeData(
          edmsDriveItemId: "1",
          webUrl: "test.pdf",
          rimNo: "RIM",
    ...
    test("linkToApplication failure", () async {
      ...
      expect(
        ...
        throwsExceptionWithMessage("Link failed"),
      );
    });
    ...
    test("uploadDigitalDocuments failure", () async {
      final mockResponse = AppResponse(
        status: ResponseStatus.error,
        message: "Upload failed", // <-- ignored by method
        body: {
          "baseResponse": {
            "status": {
              "statusCode": "500",
      ...
      expect(
        () async => fileAttachmentRepository.uploadDigitalDocuments(doc),
        throwsExceptionWithMessage("Upload success"),
      );
    });
  });
}
