    ...
    group("getFinancialDetailsFromCreditLens", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Something went wrong"),
        );
    ...
    group("getFinancialRatioAnalysisDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error fetching details"),
        );
      });
    });
    ...
    group("saveFinancialRatioAnalysisDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error saving details"),
        );
      });
    });
    ...
    group("deleteFinancialRatioAnalysisDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error deleting details"),
        );
      });
    });
    ...
    group("getGuarantorFinancialDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error fetching guarantor details"),
        );
      });
    });
    ...
    group("saveGuarantorFinancialDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error saving guarantor details"),
        );
      });
    });
    ...
    group("deleteGuarantorDetails", () {
      ...
      test("throws when API returns error status", () async {
        ...
        expect(
          ...
          throwsExceptionWithMessage("Error deleting guarantor details"),
        );
      });
    });
  });
