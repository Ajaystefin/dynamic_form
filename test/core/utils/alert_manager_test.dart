  ...
  group("AlertManager", () {
    ...
    group("showSuccessToast", () {
      ...
      test("should handle various success message types", () {
        const successWithNewlines =
            "Success with newlines:\nOperation\nCompleted";

        const veryLongSuccessMessage =
            "Very long success message that describes "
    ...
    group("showInfoToast", () {
      ...
      test("should handle various info message types", () {
        const infoWithVersion = "Info with version: v1.2.3";

        const longInfoMessage = "Very long informational message that provides "
