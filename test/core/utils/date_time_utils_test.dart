  ...
  group("DateTimeUtils", () {
    ...
    group("datetimeToInt", () {
      test("should convert valid DateTime to timestamp", () {
        final dateTime = DateTime(2023, 12, 25, 12, 0, 0);
    ...
    group("getSafeDate", () {
      ...
      test("returns local DateTime when input is DateTime", () {
        final utcDate = DateTime.utc(2025, 12, 1);
    ...
    group("intToDateTime", () {
      ...
      test("parses string milliseconds since epoch", () {
        final ts = DateTime(2025, 12, 24, 0, 0, 0).millisecondsSinceEpoch;
      ...
      test("parses MM/yyyy strict (first day of month)", () {
        ...
        expect(parsed, isA<DateTime>());
        expect(parsed, DateTime(2025, 12, 1));
      });
