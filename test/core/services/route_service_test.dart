...
RouteSettings createRouteSettings({String? name, Object? arguments}) {
...
GoRouterState createGoRouterState({
  ...
  return GoRouterState(
    ...
    uri: Uri.parse(matchedLocation.isEmpty ? "/" : matchedLocation),
    matchedLocation: matchedLocation,
    name: name,
    path: matchedLocation,
    fullPath: fullPath ?? matchedLocation,
    pathParameters: pathParameters ?? <String, String>{},
    extra: extra,
    pageKey: ValueKey<String>(matchedLocation.isEmpty ? "/" : matchedLocation),
  );
}
...
void main() {
  ...
  group("GoRouterObserver", () {
    ...
    late RouteSettings mockRouteSettings;
    late RouteSettings mockPreviousRouteSettings;

    setUp(() {
      observer = GoRouterObserver();
      mockRoute = MockRoute();
      mockPreviousRoute = MockRoute();
      mockRouteSettings = createRouteSettings();
      mockPreviousRouteSettings = createRouteSettings();

      when(() => mockRoute.settings).thenAnswer((_) => mockRouteSettings);
      when(() => mockPreviousRoute.settings)
          .thenAnswer((_) => mockPreviousRouteSettings);
    });
    ...
    group("didPush", () {
      test("should update current and previous routes with route names", () {
        mockRouteSettings = createRouteSettings(name: "/test-route");
        mockPreviousRouteSettings =
            createRouteSettings(name: "/previous-route");
      ...
      test("should handle empty route names", () {
        mockRouteSettings = createRouteSettings(name: "");
        mockPreviousRouteSettings = createRouteSettings(name: "");
      ...
      test("should handle special characters in route names", () {
        mockRouteSettings = createRouteSettings(name: "/test@route#123");
        mockPreviousRouteSettings =
            createRouteSettings(name: "/prev@route#456");
      ...
      test("should handle long route names", () {
        ...
        mockRouteSettings = createRouteSettings(name: longRoute);
        mockPreviousRouteSettings = createRouteSettings(name: "/short");
    ...
    group("didPop", () {
      ...
      test("should handle multiple pop operations", () {
        // First pop
        mockRouteSettings = createRouteSettings(name: "/route1");
        mockPreviousRouteSettings = createRouteSettings(name: "/route2");
        observer.didPop(mockRoute, mockPreviousRoute);
        ...
        // Second pop
        mockRouteSettings = createRouteSettings(name: "/route3");
        mockPreviousRouteSettings = createRouteSettings(name: "/route4");
        observer.didPop(mockRoute, mockPreviousRoute);
      ...
      test("should handle pop with same route names", () {
        mockRouteSettings = createRouteSettings(name: "/same-route");
        mockPreviousRouteSettings = createRouteSettings(name: "/same-route");
    ...
    group("didRemove", () {
      ...
      test("should handle route removal scenarios", () {
        mockRouteSettings = createRouteSettings(name: "/removed-route");
        mockPreviousRouteSettings = createRouteSettings(name: "/parent-route");
      ...
      test("should handle removal with whitespace route names", () {
        mockRouteSettings = createRouteSettings(name: " /route-with-spaces ");
        mockPreviousRouteSettings = createRouteSettings(name: "/normal");
    ...
    group("didReplace", () {
      test("should update current and previous routes with route names", () {
        ...
        final mockNewRouteSettings = createRouteSettings(name: "/new-route");
        final mockOldRouteSettings = createRouteSettings(name: "/old-route");
      ...
      test("should set default route when route names are null", () {
        final mockNewRoute = MockRoute();
        final mockOldRoute = MockRoute();
        final mockNewRouteSettings = createRouteSettings();
        final mockOldRouteSettings = createRouteSettings();
      ...
      test("should handle null new route", () {
        ...
        observer.didReplace(oldRoute: mockOldRoute);
      ...
      test("should handle null old route", () {
        ...
        observer.didReplace(newRoute: mockNewRoute);
      ...
      test("should handle route replacement scenarios", () {
        final mockNewRoute = MockRoute();
        final mockOldRoute = MockRoute();
        final mockNewRouteSettings = createRouteSettings(name: "/dashboard");
        final mockOldRouteSettings = createRouteSettings(name: "/login");
      ...
      test("should handle replacement with identical routes", () {
        final mockNewRoute = MockRoute();
        final mockOldRoute = MockRoute();
        final mockNewRouteSettings = createRouteSettings(name: "/same");
        final mockOldRouteSettings = createRouteSettings(name: "/same");
    ...
    group("Observer State Management", () {
      test("should maintain consistent state across operations", () {
        mockRouteSettings = createRouteSettings(name: "/initial-route");
        mockPreviousRouteSettings = createRouteSettings(name: "/prev-route");
      ...
      test("should handle rapid state changes", () {
        ...
        for (int i = 0; i < 10; i++) {
          mockRouteSettings = createRouteSettings(name: "/route$i");
          mockPreviousRouteSettings = createRouteSettings(name: "/prev$i");
          observer.didPush(mockRoute, mockPreviousRoute);
        }
      ...
      test("should handle mixed operation sequences", () {
        // Push
        mockRouteSettings = createRouteSettings(name: "/route1");
        mockPreviousRouteSettings = createRouteSettings(name: "/route0");
        observer.didPush(mockRoute, mockPreviousRoute);

        // Pop
        mockRouteSettings = createRouteSettings(name: "/route0");
        mockPreviousRouteSettings = createRouteSettings(name: "/");
        observer.didPop(mockRoute, mockPreviousRoute);
  ...
  group("Error Handling and Edge Cases", () {
    ...
    test("should handle concurrent observer operations", () {
      ...
      final settings1 = createRouteSettings(name: "/route1");
      final settings2 = createRouteSettings(name: "/route2");
  ...
  group("Performance Tests", () {
    ...
    test("should handle rapid route state changes", () {
      ...
      late RouteSettings previousRouteSettings;

      routeSettings = createRouteSettings();
      previousRouteSettings = createRouteSettings();

      when(() => route.settings).thenAnswer((_) => routeSettings);
      when(() => previousRoute.settings)
          .thenAnswer((_) => previousRouteSettings);

      // Perform many operations rapidly
      for (int i = 0; i < 1000; i++) {
        routeSettings = createRouteSettings(name: "/route$i");
        previousRouteSettings = createRouteSettings(name: "/prev$i");
    ...
    test("should maintain consistent performance with complex route names", () {
      ...
      settings = createRouteSettings();

      when(() => route.settings).thenAnswer((_) => settings);
      ...
      for (final routeName in complexRoutes) {
        settings = createRouteSettings(name: routeName);
  ...
  group("Additional Coverage Tests", () {
    ...
    test("should handle edge cases in observer methods", () {
      ...
      late RouteSettings mockSettings;

      mockSettings = createRouteSettings();

      when(() => mockRoute.settings).thenAnswer((_) => mockSettings);
      ...
      mockSettings = createRouteSettings(name: "");
      observer.didPush(mockRoute, null);
      expect(Globals.currentRoute, equals(""));

      // Test normal route name
      mockSettings = createRouteSettings(name: "/test");
      observer.didPush(mockRoute, null);
      expect(Globals.currentRoute, equals("/test"));

      // Test special characters
      mockSettings = createRouteSettings(name: r"/path-with-special-chars@#$%");
      observer.didPush(mockRoute, null);
      expect(Globals.currentRoute, equals(r"/path-with-special-chars@#$%"));

      // Test long path
      mockSettings =
          createRouteSettings(name: "/very/long/path/with/many/segments");
      observer.didPop(mockRoute, null);
      expect(
      ...
      // Test didRemove
      mockSettings = createRouteSettings(name: "/removed");
      observer.didRemove(mockRoute, null);
