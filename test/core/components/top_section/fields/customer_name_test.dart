...
void main() {
  group("CustomerName", () {
    testWidgets("renders with valid request data", (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(
            body: CustomerName(request: request),
          ),
        ),
      );
    ...
    testWidgets("renders with null customerName", (WidgetTester tester) async {
    ...
    testWidgets("renders with empty customerName", (WidgetTester tester) async {
    ...
    testWidgets("has required constructor parameters",
      ...
      expect(() => CustomerName(request: request), returnsNormally);
    });

    testWidgets("widget key is properly set", (WidgetTester tester) async {
      const key = Key("customer_name_test");
      final request = MockTopSectionData.createFullRequest();
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(
            body: CustomerName(key: key, request: request),
          ),
        ),
      );
    ...
    testWidgets("is a StatelessWidget", (WidgetTester tester) async {
      final request = MockTopSectionData.createFullRequest();
      final widget = CustomerName(request: request);

      expect(widget, isA<StatelessWidget>());
    });

    testWidgets("handles individual customer request",
        (WidgetTester tester) async {
      ...
      expect(find.text("Individual Customer"), findsOneWidget);
      expect(find.byType(LabelWidget), findsOneWidget);
      expect(find.byType(CustomSelectableText), findsOneWidget);
    });
  });
