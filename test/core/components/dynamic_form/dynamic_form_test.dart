...
void main() {
  group("DynamicForm", () {
    ...
    Future<void> pumpForm(
      ...
      void Function(String, Object?)? onFieldChange,
    ...
    group("setFieldVisibility", () {
      ...
      testWidgets("hides a field (sets showField=false)", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState?.setFieldVisibility("vis_field", isVisible: false);
        await tester.pump();
      ...
      testWidgets("shows a field (sets showField=true)", (tester) async {
        ...
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState?.setFieldVisibility("vis_field", isVisible: true);
        await tester.pump();
      ...
      testWidgets("does not throw for unknown key", (tester) async {
        ...
        expect(
          () => formKey.currentState
              ?.setFieldVisibility("nonexistent", isVisible: false),
          returnsNormally,
        );
      });
    });
    ...
    group("setFieldMandatory", () {
      ...
      testWidgets("makes a field mandatory", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState
            ?.setFieldMandatory("mand_field", isMandatory: true);
        await tester.pump();
      ...
      testWidgets("makes a field optional", (tester) async {
        ...
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState
            ?.setFieldMandatory("mand_field", isMandatory: false);
        await tester.pump();
      ...
      testWidgets("does not throw for unknown key", (tester) async {
        ...
        expect(
          () => formKey.currentState
              ?.setFieldMandatory("unknown", isMandatory: true),
          returnsNormally,
        );
      });
    });
    ...
    group("setFieldEnabled", () {
      ...
      testWidgets("disables a normal field", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState?.setFieldEnabled("en_field", isEnabled: false);
        await tester.pump();
      ...
      testWidgets("enables a normal field", (tester) async {
        ...
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState?.setFieldEnabled("en_field", isEnabled: true);
        await tester.pump();
      ...
      testWidgets("does not throw for unknown key", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        expect(
          () => formKey.currentState?.setFieldEnabled("nope", isEnabled: false),
          returnsNormally,
        );
      });
      ...
      testWidgets("disables a specific grid cell via index param",
        ...
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState
            ?.setFieldEnabled("en_field", isEnabled: false, index: 2);
        await tester.pump();
      ...
      testWidgets("enables a specific grid cell via index param",
        ...
        // First disable
        formKey.currentState
            ?.setFieldEnabled("en_field", isEnabled: false, index: 1);
        // Then enable
        formKey.currentState
            ?.setFieldEnabled("en_field", isEnabled: true, index: 1);
        await tester.pump();
      ...
      testWidgets("disabledGridCells returns a copy", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState
            ?.setFieldEnabled("en_field", isEnabled: false, index: 0);
      ...
      testWidgets("enabledGridCells returns a copy", (tester) async {
        await pumpForm(tester, sections: sections, document: testDocument);
        formKey.currentState
            ?.setFieldEnabled("en_field", isEnabled: true, index: 5);
