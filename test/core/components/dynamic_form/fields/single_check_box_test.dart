...
void main() {
  group("DynamicFormSingleCheckBox", () {
    ...
    late Function({bool value}) mockOnChanged;
    late Function({bool? value}) mockOnSaved;
        ...
        MaterialApp(
          home: Scaffold(
            body: DynamicFormSingleCheckBox(
              ...
              onChanged: ({value}) => testOnChanged,
              onSaved: ({value}) => mockOnSaved,
            ),
          ),
        ),
      );
    ...
    testWidgets("handles boolean value change from false to true",
      ...
      void testOnChanged({required bool value}) {
        currentValue = value;
      }
