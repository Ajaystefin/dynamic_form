...
void main() {
  group("Request", () {
    test("should create Request instance with all properties", () {
      ...
      expect(request.createdDate, DateTime(2024));
      ...
      expect(request.presentReviewDate, DateTime(2024));
      expect(request.nextReviewDate, DateTime(2024, 12, 31));
      expect(request.customerRequestReceived, DateTime(2024));
      ...
      expect(request.interimReviewDate, DateTime(2024, 6));
    ...
    test("should check if request is group request", () {
      ...
      final individualRequest = Request();
