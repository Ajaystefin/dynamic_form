...
void main() {
  ...
  group("DeleteFinancialRatioAnalysisResult", () {
    ...
    test("isSuccess should be case-insensitive", () {
      const result1 = DeleteFinancialRatioAnalysisResult(message: "SUCCESS");
      const result2 = DeleteFinancialRatioAnalysisResult(message: "Success");
      const result3 = DeleteFinancialRatioAnalysisResult(message: "success");
      const result4 = DeleteFinancialRatioAnalysisResult(message: "failed");
    ...
    test("toJson should serialize correctly", () {
      const result = DeleteFinancialRatioAnalysisResult(message: "Deleted");
