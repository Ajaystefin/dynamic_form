  ...
  group("CovenantCondition.toSaveJson", () {
    test("builds save payload with defaults and list mappings", () {
      ...
      final model = CovenantCondition(
        ...
        covConMasterId: null, // should default to 0
        appRefNum: "APP-SAVE",
        rimNo: 321,
        covenantConditionNo: "CC-SAVE",
        isCovenant: null, // should default to false
        covenantType: 5,
        isGeneric: null, // should default to false
        isNew: true,
        ...
        status: 90,
        action: 77,
        isStandard: null, // should default to true
        groupId: 808,
        periodTerm: 12,
        ...
        timeForSubmition: 30,
        covenantSubType: 3,
        isInternalFinancial: null, // should default to false
        threshold: 111,
        thresholdType: 222,
        financialYearEndDate: "2025-06-06",
        nextMonitorDate: "2025-07-07",
        conditionType: 55,
        isDeleted: null, // should default to false
        customerName: null, // should default to ''
        entityName: null, // should default to ''
        creditLensId: null, // should default to ''
