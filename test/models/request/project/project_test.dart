...
void main() {
  ...
  group("Project.fromSearchJson", () {
    test(
      ...
      final json = {
        ...
        "projectPeriod": DateTime(2025, 12, 01),
      ...
      expect(p.projectPeriod, DateTime(2025, 12, 01));
    ...
    test("handles String branches for defectLiabilityEndDate and projectPeriod",
      ...
      final json = {
        ...
        "defectLiabilityEndDate":
            "${DateTime(2026, 02, 01).millisecondsSinceEpoch}",
        "projectPeriod": "${DateTime(2026, 03, 01).millisecondsSinceEpoch}",
        "projectValue": "444",
  ...
  group("Project.fromJson / toJson", () {
    test("maps fields and converts dates, includes Contract list", () {
      final periodMs = DateTime(2025, 04, 01).millisecondsSinceEpoch;
      final liabilityMs = DateTime(2025, 05, 01).millisecondsSinceEpoch;
  ...
  group("Project.toAPIJson", () {
    test("emits API-shaped JSON including Contract when present", () {
      ...
      final p = Project(
        ...
        defectLiabilityEndDate: DateTime(2027, 01, 01),
        projectValue: "404",
        projectPeriod: DateTime(2027, 02, 01),
  ...
  group("Project.toSaveEditProjectJson - facilityId behavior", () {
    test("when isCreateProject=false, facilityId key is absent", () {
      ...
      final out = p.toSaveEditProjectJson(isCreateProject: false);
  ...
  group("Project.toSaveEditProjectJson", () {
    ...
    test("isCreateProject=true sets initial/current values and facilityId=null",
      ...
      final p = Project(
        ...
        projectPeriod: DateTime(2026, 03, 01),
        defectLiabilityEndDate: DateTime(2026, 04, 01),
      );
