  ...
  group("BusinessSegmentPayload.toJson", () {
    test(
      ...
      final payload = BusinessSegmentPayload(
        appRefNo: "APP-001",
        rimNo: 12345,
        // pass explicit values to avoid depending on ServerConstants at test
        // time
    ...
    test("omits rating and omits non-parseable numbers for popuLation/gdp", () {
      ...
      final payload = BusinessSegmentPayload(
        ...
        threats: const [],
        createdBy: "writer",
        createdDate: DateTime.utc(2024, 6, 1),
        updatedBy: "writer",
        updatedDate: DateTime.utc(2024, 6, 1),
      );
